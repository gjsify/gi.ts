 ...
 */
export function utils_enum_from_str(type: unknown, str: string): [boolean, number | null,string | null];
/**
 * Returns the list of possible values for a given enum.
 */
export function utils_enum_get_values(type: unknown, from: number, to: number): string[];
/**
 ...
 */
export function utils_enum_to_str(type: unknown, value: number): string;
/**
...
export class AccessPoint  {constructor(config?: properties);
...
export class ActiveConnection  {constructor(config?: properties);
...
export class Checkpoint  {constructor(config?: properties);
...
export class Device6Lowpan  {constructor(config?: properties);
readonly hw_address: string;
get_hw_address(): string;
get_parent(): Device;
}
export class DeviceAdsl  {constructor(config?: properties);
readonly carrier: boolean;
get_carrier(): boolean;
}
export class DeviceBond  {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceBridge  {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
readonly slaves: Device[];
get_carrier(): boolean;
...
export class DeviceBt  {constructor(config?: properties);
...
export class DeviceDummy  {constructor(config?: properties);
readonly hw_address: string;
get_hw_address(): string;
}
export class DeviceEthernet  {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceGeneric  {constructor(config?: properties);
readonly hw_address: string;
readonly type_description: string;
get_hw_address(): string;
}
export class DeviceIPTunnel  {constructor(config?: properties);
...
export class DeviceInfiniband  {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
get_carrier(): boolean;
get_hw_address(): string;
}
export class DeviceMacsec  {constructor(config?: properties);
...
export class DeviceMacvlan  {constructor(config?: properties);
readonly hw_address: string;
...
export class DeviceModem  {constructor(config?: properties);
readonly apn: string;
...
export class DeviceOlpcMesh  {constructor(config?: properties);
...
export class DeviceOvsBridge  {constructor(config?: properties);
get_slaves(): Device[];
}
export class DeviceOvsInterface  {constructor(config?: properties);
}
export class DeviceOvsPort  {constructor(config?: properties);
get_slaves(): Device[];
}
export class DevicePpp  {constructor(config?: properties);
}
export class DeviceTeam  {constructor(config?: properties);
readonly carrier: boolean;
...
export class DeviceTun  {constructor(config?: properties);
...
export class DeviceVlan  {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceVxlan  {constructor(config?: properties);
...
export class DeviceWifi  {constructor(config?: properties);
...
export class DeviceWifiP2P  {constructor(config?: properties);
readonly hw_address: string;
...
export class DeviceWimax  {constructor(config?: properties);
...
export class DeviceWireGuard  {constructor(config?: properties);
...
export class DeviceWpan  {constructor(config?: properties);
readonly hw_address: string;
get_hw_address(): string;
}
export class DhcpConfig  {constructor(config?: properties);
...
export class IPConfig  {constructor(config?: properties);
...
dbus_object_manager: Gio.DBusObjectManager;
readonly path: string;
get_path(): string;
}
export class RemoteConnection  {constructor(config?: properties);
...
export class SecretAgentOld  {constructor(config?: properties);
...
export class Setting  {constructor(config?: properties);
readonly name: string;
...
static lookup_type(name: string): unknown;
}
export class Setting6Lowpan extends Setting {constructor(config?: properties);
get_parent(): string;
}
...
export class SettingDummy extends Setting {constructor(config?: properties);
}
export class SettingEthtool extends Setting {constructor(config?: properties);
clear_features(): void;
...
export class SettingIP4Config extends SettingIPConfig {constructor(config?: properties);
dhcp_client_id: string;
dhcp_fqdn: string;
get_dhcp_client_id(): string;
get_dhcp_fqdn(): string;
}
export class SettingIP6Config extends SettingIPConfig {constructor(config?: properties);
...
export class SettingIPConfig  {constructor(config?: properties);
addresses: IPAddress[];
dad_timeout: number;
...
export class SettingIPTunnel extends Setting {constructor(config?: properties);
...
export class SettingMacsec extends Setting {constructor(config?: properties);
encrypt: boolean;
mka_cak: string;
...
export class SettingMacvlan extends Setting {constructor(config?: properties);
mode: number;
promiscuous: boolean;
tap: boolean;
...
export class SettingMatch extends Setting {constructor(config?: properties);
interface_name: string[];
...
export class SettingOvsBridge extends Setting {constructor(config?: properties);
...
export class SettingOvsDpdk extends Setting {constructor(config?: properties);
devargs: string;
get_devargs(): string;
}
export class SettingOvsInterface extends Setting {constructor(config?: properties);
type: string;
get_interface_type(): string;
}
export class SettingOvsPatch extends Setting {constructor(config?: properties);
peer: string;
get_peer(): string;
}
export class SettingOvsPort extends Setting {constructor(config?: properties);
...
export class SettingProxy extends Setting {constructor(config?: properties);
...
export class SettingSriov extends Setting {constructor(config?: properties);
...
export class SettingTCConfig extends Setting {constructor(config?: properties);
qdiscs: TCQdisc[];
tfilters: TCTfilter[];
...
export class SettingTun extends Setting {constructor(config?: properties);
group: string;
mode: number;
multi_queue: boolean;
owner: string;
...
export class SettingUser extends Setting {constructor(config?: properties);
data: GLib.HashTable;
...
export class SettingVxlan extends Setting {constructor(config?: properties);
ageing: number;
...
export class SettingWifiP2P extends Setting {constructor(config?: properties);
peer: string;
wfd_ies: GLib.Bytes;
wps_method: number;
get_peer(): string;
...
export class SettingWireGuard extends Setting {constructor(config?: properties);
fwmark: number;
...
export class SettingWpan extends Setting {constructor(config?: properties);
channel: number;
mac_address: string;
page: number;
pan_id: number;
...
export class SimpleConnection  {constructor(config?: properties);
static _new(): Connection;
static new_clone(connection: Connection): Connection;
static new_from_dbus(dict: GLib.Variant): Connection;
}
export class VpnConnection  {constructor(config?: properties);
readonly banner: string;
readonly vpn_state: VpnConnectionState;
get_banner(): string;
get_vpn_state(): VpnConnectionState;
}
export class VpnPluginInfo extends GObject.Object {constructor(config?: properties);
filename: string;
...
export class VpnPluginOld  {constructor(config?: properties);
service_name: string;
...
export class VpnServicePlugin  {constructor(config?: properties);
service_name: string;
state: VpnServiceState;
watch_peer: boolean;
disconnect(): boolean;
...
export class WifiP2PPeer  {constructor(config?: properties);
readonly flags: Gjs_80211ApFlags;
readonly hw_address: string;
readonly last_seen: number;
...
export class WimaxNsp  {constructor(config?: properties);
readonly name: string;
...
export class AccessPointClass  {constructor(config?: properties);
readonly padding: object[];
}
export class ActiveConnectionClass  {constructor(config?: properties);
readonly padding: object[];
}
export class BridgeVlan  {constructor(config?: properties);
...
export class CheckpointClass  {constructor(config?: properties);
}
export class ClientClass  {constructor(config?: properties);
readonly device_added: unknown;
readonly device_removed: unknown;
readonly any_device_added: unknown;
readonly any_device_removed: unknown;
readonly permission_changed: unknown;
readonly connection_added: unknown;
readonly connection_removed: unknown;
readonly padding: object[];
}
export class ConnectionInterface  {constructor(config?: properties);
readonly secrets_updated: unknown;
readonly secrets_cleared: unknown;
readonly changed: unknown;
}
export class DeviceAdslClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceBondClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceBridgeClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceBtClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceClass  {constructor(config?: properties);
readonly state_changed: unknown;
readonly connection_compatible: unknown;
readonly get_type_description: unknown;
readonly get_hw_address: unknown;
readonly get_setting_type: unknown;
readonly padding: object[];
}
export class DeviceDummyClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceEthernetClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceGenericClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceIPTunnelClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceInfinibandClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceMacsecClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceMacvlanClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceModemClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceOlpcMeshClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceOvsBridgeClass  {constructor(config?: properties);
}
export class DeviceOvsInterfaceClass  {constructor(config?: properties);
}
export class DeviceOvsPortClass  {constructor(config?: properties);
}
export class DevicePppClass  {constructor(config?: properties);
}
export class DeviceTeamClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceTunClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceVlanClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceVxlanClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DeviceWifiClass  {constructor(config?: properties);
readonly access_point_added: unknown;
readonly access_point_removed: unknown;
readonly padding: object[];
}
export class DeviceWifiP2PClass  {constructor(config?: properties);
}
export class DeviceWimaxClass  {constructor(config?: properties);
readonly nsp_added: unknown;
readonly nsp_removed: unknown;
readonly padding: object[];
}
export class DeviceWireGuardClass  {constructor(config?: properties);
}
export class DhcpConfigClass  {constructor(config?: properties);
readonly padding: object[];
}
export class DnsEntry  {constructor(config?: properties);
get_domains(): string[];
...
set_address_binary(addr: object | null): void;
set_attribute(name: string, value: GLib.Variant | null): void;
set_prefix(prefix: number): void;
unref(): void;
}
export class IPConfigClass  {constructor(config?: properties);
readonly padding: object[];
}
export class IPRoute  {constructor(config?: properties);
...
get_attribute_names(): string[];
get_dest(): string;
get_dest_binary(dest: object | null): void;
get_family(): number;
get_metric(): number;
get_next_hop(): string;
get_next_hop_binary(next_hop: object | null): boolean;
get_prefix(): number;
ref(): void;
set_attribute(name: string, value: GLib.Variant | null): void;
set_dest(dest: string): void;
set_dest_binary(dest: object | null): void;
set_metric(metric: number): void;
set_next_hop(next_hop: string | null): void;
set_next_hop_binary(next_hop: object | null): void;
set_prefix(prefix: number): void;
unref(): void;
...
export class IPRoutingRule  {constructor(config?: properties);
...
export class LldpNeighbor  {constructor(config?: properties);
...
readonly init_dbus: unknown;
readonly object_creation_failed: unknown;
readonly padding: object[];
}
export class RemoteConnectionClass  {constructor(config?: properties);
readonly parent_class: ObjectClass;
readonly padding: object[];
}
export class SecretAgentOldClass  {constructor(config?: properties);
readonly get_secrets: unknown;
readonly cancel_get_secrets: unknown;
readonly save_secrets: unknown;
readonly delete_secrets: unknown;
readonly padding: object[];
}
export class Setting6LowpanClass  {constructor(config?: properties);
}
...
readonly verify_secrets: unknown;
...
readonly clear_secrets: unknown;
readonly compare_property: unknown;
readonly duplicate_copy_properties: unknown;
readonly enumerate_values: unknown;
readonly aggregate: unknown;
readonly for_each_secret: unknown;
readonly init_from_dbus: unknown;
readonly padding: object[];
readonly setting_info: object;
}
...
export class SettingDummyClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingEthtoolClass  {constructor(config?: properties);
}
...
export class SettingIPConfigClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingIPTunnelClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingInfinibandClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingMacsecClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingMacvlanClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingMatchClass  {constructor(config?: properties);
}
export class SettingOlpcMeshClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingOvsBridgeClass  {constructor(config?: properties);
}
export class SettingOvsDpdkClass  {constructor(config?: properties);
}
export class SettingOvsInterfaceClass  {constructor(config?: properties);
}
export class SettingOvsPatchClass  {constructor(config?: properties);
}
export class SettingOvsPortClass  {constructor(config?: properties);
}
...
export class SettingProxyClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingSerialClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingSriovClass  {constructor(config?: properties);
}
export class SettingTCConfigClass  {constructor(config?: properties);
}
...
export class SettingTunClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingUserClass  {constructor(config?: properties);
}
...
export class SettingVxlanClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingWifiP2PClass  {constructor(config?: properties);
}
export class SettingWimaxClass  {constructor(config?: properties);
readonly padding: object[];
}
export class SettingWireGuardClass  {constructor(config?: properties);
}
...
export class SettingWpanClass  {constructor(config?: properties);
}
export class SimpleConnectionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class SriovVF  {constructor(config?: properties);
...
export class TCAction  {constructor(config?: properties);
dup(): TCAction;
...
export class TCQdisc  {constructor(config?: properties);
dup(): TCQdisc;
...
export class TCTfilter  {constructor(config?: properties);
dup(): TCTfilter;
...
export class TeamLinkWatcher  {constructor(config?: properties);
...
export class VariantAttributeSpec  {constructor(config?: properties);
}
export class VpnConnectionClass  {constructor(config?: properties);
readonly vpn_state_changed: unknown;
readonly padding: object[];
}
export class VpnEditorInterface  {constructor(config?: properties);
readonly g_iface: GObject.TypeInterface;
readonly get_widget: unknown;
readonly placeholder: unknown;
readonly update_connection: unknown;
readonly changed: unknown;
}
export class VpnEditorPluginInterface  {constructor(config?: properties);
readonly g_iface: GObject.TypeInterface;
readonly get_editor: unknown;
readonly get_capabilities: unknown;
readonly import_from_file: unknown;
readonly export_to_file: unknown;
readonly get_suggested_filename: unknown;
readonly notify_plugin_info_set: unknown;
readonly get_vt: unknown;
}
export class VpnEditorPluginVT  {constructor(config?: properties);
}
export class VpnPluginInfoClass  {constructor(config?: properties);
readonly padding: object[];
}
export class VpnPluginOldClass  {constructor(config?: properties);
readonly state_changed: unknown;
readonly ip4_config: unknown;
readonly login_banner: unknown;
readonly failure: unknown;
readonly quit: unknown;
readonly config: unknown;
readonly ip6_config: unknown;
readonly connect: unknown;
readonly need_secrets: unknown;
readonly disconnect: unknown;
readonly new_secrets: unknown;
readonly connect_interactive: unknown;
readonly padding: object[];
}
export class VpnServicePluginClass  {constructor(config?: properties);
readonly state_changed: unknown;
readonly ip4_config: unknown;
readonly login_banner: unknown;
readonly failure: unknown;
...
export class WifiP2PPeerClass  {constructor(config?: properties);
}
export class WimaxNspClass  {constructor(config?: properties);
readonly padding: object[];
}
export class WireGuardPeer  {constructor(config?: properties);
