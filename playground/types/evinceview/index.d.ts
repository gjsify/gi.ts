...
export class DocumentModel extends GObject.Object {constructor(config?: properties);
continuous: boolean;
...
export class Job  {constructor(config?: properties);
...
cancel(): void;
failed(domain: GLib.Quark, code: number, format: string, ___: unknown[]): void;
...
export class JobAnnots extends Job {constructor(config?: properties);
}
export class JobAttachments extends Job {constructor(config?: properties);
}
export class JobExport extends Job {constructor(config?: properties);
set_page(page: number): void;
}
export class JobFind extends Job {constructor(config?: properties);
get_n_results(pages: number): number;
get_options(): EvinceDocument.FindOptions;
get_progress(): number;
get_results(): GLib.List;
has_results(): boolean;
set_options(options: EvinceDocument.FindOptions): void;
vfunc_updated(page: number): void;
}
export class JobFonts extends Job {constructor(config?: properties);
vfunc_updated(progress: number): void;
}
export class JobLayers extends Job {constructor(config?: properties);
}
export class JobLinks extends Job {constructor(config?: properties);
get_model(): Gtk.TreeModel;
}
export class JobLoad extends Job {constructor(config?: properties);
set_password(password: string): void;
set_uri(uri: string): void;
}
export class JobLoadGFile extends Job {constructor(config?: properties);
set_gfile(gfile: Gio.File): void;
set_load_flags(flags: EvinceDocument.DocumentLoadFlags): void;
set_password(password: string): void;
}
export class JobLoadStream extends Job {constructor(config?: properties);
set_load_flags(flags: EvinceDocument.DocumentLoadFlags): void;
set_password(password: string): void;
set_stream(stream: Gio.InputStream): void;
}
export class JobPageData extends Job {constructor(config?: properties);
}
export class JobPrint extends Job {constructor(config?: properties);
set_cairo(cr: cairo.Context): void;
set_page(page: number): void;
}
export class JobRender extends Job {constructor(config?: properties);
...
export class JobSave extends Job {constructor(config?: properties);
}
export class JobThumbnail extends Job {constructor(config?: properties);
...
export class View extends Gtk.Container {constructor(config?: properties);
...
find_cancel(): void;
find_changed(results: GLib.List, page: number): void;
find_next(): void;
find_previous(): void;
...
export class ViewPresentation extends Gtk.Widget {constructor(config?: properties);
current_page: number;
document: EvinceDocument.Document;
inverted_colors: boolean;
rotation: number;
...
export class DocumentModelClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class JobAnnotsClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobAttachmentsClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly run: unknown;
readonly cancelled: unknown;
readonly finished: unknown;
}
export class JobExportClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobFindClass  {constructor(config?: properties);
readonly parent_class: JobClass;
readonly updated: unknown;
}
export class JobFontsClass  {constructor(config?: properties);
readonly parent_class: JobClass;
readonly updated: unknown;
}
export class JobLayersClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobLinksClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobLoadClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobLoadGFileClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobLoadStreamClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobPageDataClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobPrintClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobRenderClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobSaveClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
export class JobThumbnailClass  {constructor(config?: properties);
readonly parent_class: JobClass;
}
...
export class ViewPresentationClass  {constructor(config?: properties);
}