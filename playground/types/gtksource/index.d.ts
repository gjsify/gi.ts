...
export class Buffer extends Gtk.TextBuffer {constructor(config?: properties);
...
create_source_tag(tag_name: string | null, first_property_name: string | null, ___: unknown[]): Gtk.TextTag;
...
export class Completion  {constructor(config?: properties);
accelerators: number;
...
export class CompletionContext  {constructor(config?: properties);
...
export class CompletionInfo extends Gtk.Window {constructor(config?: properties);
...
export class CompletionItem extends GObject.Object {constructor(config?: properties);
gicon: Gio.Icon;
...
export class CompletionWords extends GObject.Object {constructor(config?: properties);
activation: CompletionActivation;
icon: GdkPixbuf.Pixbuf;
...
export class FileLoader extends GObject.Object {constructor(config?: properties);
buffer: Buffer;
file: File;
...
export class FileSaver extends GObject.Object {constructor(config?: properties);
buffer: Buffer;
...
export class Gutter  {constructor(config?: properties);
view: View;
...
export class GutterRenderer  {constructor(config?: properties);
...
export class GutterRendererPixbuf extends GutterRenderer {constructor(config?: properties);
gicon: Gio.Icon;
icon_name: string;
...
export class GutterRendererText extends GutterRenderer {constructor(config?: properties);
markup: string;
text: string;
...
export class LanguageManager extends GObject.Object {constructor(config?: properties);
...
export class Map extends View {constructor(config?: properties);
font_desc: Pango.FontDescription;
view: View;
get_view(): View | null;
set_view(view: View): void;
}
export class Mark extends Gtk.TextMark {constructor(config?: properties);
category: string;
get_category(): string;
next(category: string | null): Mark | null;
prev(category: string): Mark | null;
}
export class MarkAttributes extends GObject.Object {constructor(config?: properties);
background: Gdk.RGBA;
gicon: Gio.Icon;
icon_name: string;
pixbuf: GdkPixbuf.Pixbuf;
...
export class PrintCompositor extends GObject.Object {constructor(config?: properties);
...
export class Region extends GObject.Object {constructor(config?: properties);
...
export class SearchContext extends GObject.Object {constructor(config?: properties);
buffer: Buffer;
highlight: boolean;
match_style: Style;
...
export class SearchSettings extends GObject.Object {constructor(config?: properties);
...
export class SpaceDrawer extends GObject.Object {constructor(config?: properties);
...
export class Style  {constructor(config?: properties);
background: string;
background_set: boolean;
bold: boolean;
bold_set: boolean;
...
export class StyleScheme  {constructor(config?: properties);
...
export class StyleSchemeChooserButton extends Gtk.Button {constructor(config?: properties);
}
export class StyleSchemeChooserWidget extends Gtk.Bin {constructor(config?: properties);
}
export class StyleSchemeManager extends GObject.Object {constructor(config?: properties);
...
export class Tag extends Gtk.TextTag {constructor(config?: properties);
draw_spaces: boolean;
draw_spaces_set: boolean;
}
export class View extends Gtk.TextView {constructor(config?: properties);
auto_indent: boolean;
...
export class BufferClass  {constructor(config?: properties);
readonly parent_class: Gtk.TextBufferClass;
readonly undo: unknown;
readonly redo: unknown;
readonly bracket_matched: unknown;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
readonly _gtk_source_reserved3: unknown;
}
export class BufferPrivate  {constructor(config?: properties);
}
export class CompletionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly proposal_activated: unknown;
readonly show: unknown;
readonly hide: unknown;
readonly populate_context: unknown;
readonly move_cursor: unknown;
readonly move_page: unknown;
readonly activate_proposal: unknown;
}
export class CompletionContextClass  {constructor(config?: properties);
...
export class CompletionContextPrivate  {constructor(config?: properties);
}
export class CompletionInfoClass  {constructor(config?: properties);
readonly parent_class: Gtk.WindowClass;
readonly before_show: unknown;
}
export class CompletionInfoPrivate  {constructor(config?: properties);
}
export class CompletionItemClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class CompletionItemPrivate  {constructor(config?: properties);
}
export class CompletionPrivate  {constructor(config?: properties);
}
export class CompletionProposalIface  {constructor(config?: properties);
readonly get_label: unknown;
readonly get_markup: unknown;
readonly get_text: unknown;
readonly get_icon: unknown;
readonly get_icon_name: unknown;
readonly get_gicon: unknown;
readonly get_info: unknown;
readonly hash: unknown;
readonly equal: unknown;
readonly changed: unknown;
}
export class CompletionProviderIface  {constructor(config?: properties);
...
readonly get_activation: unknown;
readonly get_info_widget: unknown;
readonly update_info: unknown;
readonly get_start_iter: unknown;
readonly activate_proposal: unknown;
readonly get_interactive_delay: unknown;
readonly get_priority: unknown;
}
export class CompletionWordsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class CompletionWordsPrivate  {constructor(config?: properties);
}
...
export class FileLoaderClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class FileLoaderPrivate  {constructor(config?: properties);
}
export class FilePrivate  {constructor(config?: properties);
}
export class FileSaverClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class FileSaverPrivate  {constructor(config?: properties);
}
export class GutterClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class GutterPrivate  {constructor(config?: properties);
}
export class GutterRendererClass  {constructor(config?: properties);
readonly parent_class: GObject.InitiallyUnownedClass;
readonly begin: unknown;
readonly end: unknown;
readonly change_view: unknown;
readonly change_buffer: unknown;
readonly query_activatable: unknown;
readonly activate: unknown;
readonly queue_draw: unknown;
readonly query_tooltip: unknown;
readonly query_data: unknown;
}
export class GutterRendererPixbufClass  {constructor(config?: properties);
readonly parent_class: GutterRendererClass;
}
export class GutterRendererPixbufPrivate  {constructor(config?: properties);
}
export class GutterRendererPrivate  {constructor(config?: properties);
}
export class GutterRendererTextClass  {constructor(config?: properties);
readonly parent_class: GutterRendererClass;
}
export class GutterRendererTextPrivate  {constructor(config?: properties);
}
export class LanguageClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
}
export class LanguageManagerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
readonly _gtk_source_reserved3: unknown;
readonly _gtk_source_reserved4: unknown;
}
export class LanguageManagerPrivate  {constructor(config?: properties);
}
export class LanguagePrivate  {constructor(config?: properties);
}
export class MapClass  {constructor(config?: properties);
readonly parent_class: ViewClass;
readonly padding: object[];
}
export class MarkAttributesClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class MarkAttributesPrivate  {constructor(config?: properties);
}
export class MarkClass  {constructor(config?: properties);
readonly parent_class: Gtk.TextMarkClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
}
export class MarkPrivate  {constructor(config?: properties);
}
export class PrintCompositorClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
}
export class PrintCompositorPrivate  {constructor(config?: properties);
}
export class RegionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class RegionIter  {constructor(config?: properties);
...
export class SearchContextClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class SearchContextPrivate  {constructor(config?: properties);
}
export class SearchSettingsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class SearchSettingsPrivate  {constructor(config?: properties);
}
export class SpaceDrawerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class SpaceDrawerPrivate  {constructor(config?: properties);
}
export class StyleClass  {constructor(config?: properties);
}
export class StyleSchemeChooserButtonClass  {constructor(config?: properties);
}
export class StyleSchemeChooserInterface  {constructor(config?: properties);
readonly base_interface: GObject.TypeInterface;
readonly get_style_scheme: unknown;
readonly set_style_scheme: unknown;
readonly padding: object[];
}
export class StyleSchemeChooserWidgetClass  {constructor(config?: properties);
}
export class StyleSchemeClass  {constructor(config?: properties);
readonly base_class: GObject.ObjectClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
}
export class StyleSchemeManagerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gtk_source_reserved1: unknown;
readonly _gtk_source_reserved2: unknown;
readonly _gtk_source_reserved3: unknown;
...
export class StyleSchemeManagerPrivate  {constructor(config?: properties);
}
export class StyleSchemePrivate  {constructor(config?: properties);
}
export class TagClass  {constructor(config?: properties);
readonly parent_class: Gtk.TextTagClass;
readonly padding: object[];
}
export class UndoManagerIface  {constructor(config?: properties);
readonly can_undo: unknown;
readonly can_redo: unknown;
readonly undo: unknown;
readonly redo: unknown;
readonly begin_not_undoable_action: unknown;
readonly end_not_undoable_action: unknown;
readonly can_undo_changed: unknown;
readonly can_redo_changed: unknown;
}
export class ViewClass  {constructor(config?: properties);
readonly parent_class: Gtk.TextViewClass;
readonly undo: unknown;
readonly redo: unknown;
readonly line_mark_activated: unknown;
readonly show_completion: unknown;
readonly move_lines: unknown;
readonly move_words: unknown;
}
export class ViewPrivate  {constructor(config?: properties);
}
