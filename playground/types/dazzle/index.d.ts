...
export const LOG_LEVEL_TRACE: GLib.LogLevelFlags;
 ...
 * 
 */
export function gdk_synthesize_event_key(window: Gdk.Window, ch: number): Gdk.EventKey;
/**
 * 
 */
export function gdk_synthesize_event_keyval(window: Gdk.Window, keyval: number): Gdk.EventKey;
/**
 * 
 */
 ...
 * 
 */
export function gtk_widget_action_set(widget: Gtk.Widget, group: string, name: string, first_property: string, ___: unknown[]): void;
/**
 * 
 */
 ...
 */
export function gtk_widget_find_child_typed(widget: Gtk.Widget, type: unknown): Gtk.Widget | null;
/**
 ...
 */
export function gtk_widget_get_relative(widget: Gtk.Widget, relative_type: unknown): Gtk.Widget | null;
/**
 * 
 */
...
/**
 * Animates the properties of @object. The can be set in a similar manner
 *  to g_object_set(). They
 * will be animated from their current value to the target value over the
 *  time period.
 */
export function object_animate(object: object | null, mode: AnimationMode, duration_msec: number, frame_clock: Gdk.FrameClock, first_property: string, ___: unknown[]): Animation;
/**
 * 
 */
export function object_animate_full(object: object | null, mode: AnimationMode, duration_msec: number, frame_clock: Gdk.FrameClock, notify: GLib.DestroyNotify, notify_data: object | null, first_property: string, ___: unknown[]): Animation;
/**
 * 
 */
export function object_animatev(object: object | null, mode: AnimationMode, duration_msec: number, frame_clock: Gdk.FrameClock | null, first_property: string, args: any): Animation;
/**
 * 
 */
 ...
 * 
 */
export function shortcut_chord_table_get_type(): unknown;
/**
 * 
 */
export function shortcut_chord_table_new(): ShortcutChordTable;
...
export class Animation  {constructor(config?: properties);
duration: number;
...
export class Application extends Gtk.Application {constructor(config?: properties);
...
export class Bin extends Gtk.Bin {constructor(config?: properties);
}
export class BindingGroup extends GObject.Object {constructor(config?: properties);
...
export class BoldingLabel extends Gtk.Label {constructor(config?: properties);
...
export class Box extends Gtk.Box {constructor(config?: properties);
...
export class BoxTheatric  {constructor(config?: properties);
alpha: number;
background: string;
height: number;
icon: Gio.Icon;
...
export class CenteringBin extends Gtk.Bin {constructor(config?: properties);
max_width_request: number;
}
export class ChildPropertyAction  {constructor(config?: properties);
...
export class ColumnLayout extends Gtk.Container {constructor(config?: properties);
...
export class CountersWindow extends Gtk.Window {constructor(config?: properties);
get_arena(): CounterArena | null;
set_arena(arena: CounterArena): void;
}
export class CpuGraph extends GraphView {constructor(config?: properties);
max_samples: number;
timespan: number;static new_full(timespan: number, max_samples: number): Gtk.Widget;
}
export class CpuModel extends GraphModel {constructor(config?: properties);
}
export class CssProvider extends Gtk.CssProvider {constructor(config?: properties);
base_path: string;
}
export class DirectoryModel  {constructor(config?: properties);
directory: Gio.File;
...
export class DirectoryReaper extends GObject.Object {constructor(config?: properties);
...
export class DockBin extends Gtk.Container {constructor(config?: properties);
...
vfunc_create_edge(edge: Gtk.PositionType): Gtk.Widget;
}
export class DockBinEdge  {constructor(config?: properties);
edge: Gtk.PositionType;
get_edge(): Gtk.PositionType;
}
export class DockManager extends GObject.Object {constructor(config?: properties);
pause_grabs(): void;
...
export class DockOverlay extends Gtk.EventBox {constructor(config?: properties);
...
export class DockOverlayEdge  {constructor(config?: properties);
edge: Gtk.PositionType;
position: number;
get_edge(): Gtk.PositionType;
get_position(): number;
...
export class DockPaned extends MultiPaned {constructor(config?: properties);
}
export class DockRevealer extends Bin {constructor(config?: properties);
...
export class DockStack extends Gtk.Box {constructor(config?: properties);
edge: Gtk.PositionType;
...
export class DockTransientGrab extends GObject.Object {constructor(config?: properties);
timeout: number;
acquire(): void;
...
export class DockWidget extends Bin {constructor(config?: properties);
can_close: boolean;
gicon: Gio.Icon;
icon_name: string;
manager: DockManager;
...
export class DockWindow extends Gtk.Window {constructor(config?: properties);
}
export class ElasticBin extends Gtk.Bin {constructor(config?: properties);
}
export class EmptyState extends Gtk.Bin {constructor(config?: properties);
icon_name: string;
pixel_size: number;
resource: string;
subtitle: string;
...
export class EntryBox extends Gtk.Box {constructor(config?: properties);
max_width_chars: number;
}
export class FileChooserEntry extends Gtk.Bin {constructor(config?: properties);
...
export class FileTransfer extends GObject.Object {constructor(config?: properties);
...
export class FuzzyIndex extends GObject.Object {constructor(config?: properties);
...
export class FuzzyIndexBuilder extends GObject.Object {constructor(config?: properties);
...
export class FuzzyIndexCursor  {constructor(config?: properties);
case_sensitive: boolean;
index: FuzzyIndex;
max_matches: number;
query: string;
...
export class FuzzyIndexMatch  {constructor(config?: properties);
...
export class GraphColumn extends GObject.Object {constructor(config?: properties);
name: string;
value_type: unknown;
get_name(): string;
set_name(name: string): void;
}
export class GraphLineRenderer extends GObject.Object {constructor(config?: properties);
column: number;
line_width: number;
stroke_color: string;
...
export class GraphModel extends GObject.Object {constructor(config?: properties);
max_samples: number;
timespan: number;
value_max: number;
value_min: number;
...
static iter_get(iter: GraphModelIter, first_column: number, ___: unknown[]): void;
...
static iter_set(iter: GraphModelIter, first_column: number, ___: unknown[]): void;
static iter_set_value(iter: GraphModelIter, column: number, value: GObject.Value): void;
}
export class GraphView extends Gtk.DrawingArea {constructor(config?: properties);
model: GraphModel;
add_renderer(renderer: GraphRenderer): void;
get_model(): GraphModel | null;
set_model(model: GraphModel): void;
}
export class JoinedMenu extends Gio.MenuModel {constructor(config?: properties);
...
export class ListBox extends Gtk.ListBox {constructor(config?: properties);
property_name: string;
row_type: unknown;
row_type_name: string;
get_model(): Gio.ListModel | null;
get_property_name(): string;
get_row_type(): unknown;
set_model(model: Gio.ListModel): void;
set_recycle_max(recycle_max: number): void;
}
export class ListBoxRow  {constructor(config?: properties);
}
export class ListModelFilter extends GObject.Object {constructor(config?: properties);
...
export class ListStoreAdapter extends GObject.Object {constructor(config?: properties);
model: Gio.ListModel;
get_model(): Gio.ListModel;
set_model(model: Gio.ListModel): void;
}
export class MenuButton extends Gtk.MenuButton {constructor(config?: properties);
icon_name: string;
menu_id: string;
model: Gio.MenuModel;
show_accels: boolean;
...
export class MenuManager extends GObject.Object {constructor(config?: properties);
...
export class MultiPaned extends Gtk.Container {constructor(config?: properties);
...
export class PathBar extends Gtk.Box {constructor(config?: properties);
path: Path;
get_path(): Path;
set_path(path: Path): void;
set_selected_index(index: number): void;
}
export class PathElement extends GObject.Object {constructor(config?: properties);
icon_name: string;
id: string;
title: string;
...
export class PillBox extends Gtk.EventBox {constructor(config?: properties);
label: string;
get_label(): string;
set_label(label: string): void;
}
export class PreferencesBin  {constructor(config?: properties);
keywords: string;
path: string;
priority: number;
schema_id: string;
}
export class PreferencesEntry  {constructor(config?: properties);
text: string;
title: string;
get_entry_widget(): Gtk.Widget;
get_title_widget(): Gtk.Widget;
}
export class PreferencesFileChooserButton  {constructor(config?: properties);
action: Gtk.FileChooserAction;
key: string;
subtitle: string;
title: string;
}
export class PreferencesFlowBox extends ColumnLayout {constructor(config?: properties);
}
export class PreferencesFontButton  {constructor(config?: properties);
key: string;
title: string;
}
export class PreferencesGroup  {constructor(config?: properties);
is_list: boolean;
...
export class PreferencesPage  {constructor(config?: properties);
priority: number;
...
export class PreferencesSpinButton  {constructor(config?: properties);
key: string;
subtitle: string;
title: string;
get_spin_button(): Gtk.Widget;
}
export class PreferencesSwitch  {constructor(config?: properties);
is_radio: boolean;
key: string;
subtitle: string;
target: GLib.Variant;
...
export class PreferencesView extends Gtk.Bin {constructor(config?: properties);
...
export class PriorityBox extends Gtk.Box {constructor(config?: properties);
}
export class ProgressButton extends Gtk.Button {constructor(config?: properties);
progress: number;
...
export class ProgressIcon extends Gtk.DrawingArea {constructor(config?: properties);
progress: number;
get_progress(): number;
set_progress(progress: number): void;
}
export class ProgressMenuButton extends Gtk.MenuButton {constructor(config?: properties);
progress: number;
show_progress: boolean;
...
export class PropertiesGroup extends GObject.Object {constructor(config?: properties);
object: GObject.Object;
object_type: unknown;static new_for_type(object_type: unknown): PropertiesGroup;
...
export class RadioBox extends Gtk.Bin {constructor(config?: properties);
active_id: string;
...
export class ReadOnlyListModel  {constructor(config?: properties);
base_model: Gio.ListModel;
static _new(base_model: Gio.ListModel): Gio.ListModel;
}
export class RecursiveFileMonitor extends GObject.Object {constructor(config?: properties);
root: Gio.File;
cancel(): void;
get_root(): Gio.File;
...
export class ScrolledWindow  {constructor(config?: properties);
}
...
export class SettingsFlagAction  {constructor(config?: properties);
flag_nick: string;
schema_id: string;
schema_key: string;
static _new(schema_id: string, schema_key: string, flag_nick: string): Gio.Action;
}
export class SettingsSandwich extends GObject.Object {constructor(config?: properties);
path: string;
schema_id: string;
...
export class ShortcutAccelDialog extends Gtk.Dialog {constructor(config?: properties);
accelerator: string;
...
export class ShortcutContext extends GObject.Object {constructor(config?: properties);
name: string;
...
add_signal(accel: string, signal_name: string, n_args: number, ___: unknown[]): void;
add_signal_va_list(accel: string, signal_name: string, n_args: number, args: any): void;
...
export class ShortcutController extends GObject.Object {constructor(config?: properties);
...
add_command_signal(command_id: string, default_accel: string, phase: ShortcutPhase, signal_name: string, n_args: number, ___: unknown[]): void;
...
export class ShortcutLabel extends Gtk.Box {constructor(config?: properties);
accelerator: string;
chord: ShortcutChord;
get_accelerator(): string;
...
export class ShortcutManager  {constructor(config?: properties);
theme: ShortcutTheme;
theme_name: string;
user_dir: string;
...
export class ShortcutModel  {constructor(config?: properties);
manager: ShortcutManager;
theme: ShortcutTheme;
get_manager(): ShortcutManager;
get_theme(): ShortcutTheme;
...
export class ShortcutSimpleLabel extends Gtk.Box {constructor(config?: properties);
accel: string;
action: string;
command: string;
show_accel: boolean;
...
export class ShortcutTheme extends GObject.Object {constructor(config?: properties);
name: string;
parent_name: string;
subtitle: string;
title: string;
...
export class ShortcutThemeEditor extends Gtk.Bin {constructor(config?: properties);
theme: ShortcutTheme;
get_theme(): ShortcutTheme | null;
set_theme(theme: ShortcutTheme): void;
}
export class ShortcutTooltip extends GObject.Object {constructor(config?: properties);
accel: string;
command_id: string;
title: string;
widget: Gtk.Widget;
...
export class SignalGroup extends GObject.Object {constructor(config?: properties);
target: GObject.Object;
target_type: unknown;
block(): void;
connect(detailed_signal: string, c_handler: GObject.Callback, data: object | null): void;
connect(...args: never[]): never;
connect_after(detailed_signal: string, c_handler: GObject.Callback, data: object | null): void;
...
connect_object(detailed_signal: string, c_handler: GObject.Callback, object: object | null, flags: GObject.ConnectFlags): void;
...
export class SimpleLabel extends Gtk.Widget {constructor(config?: properties);
label: string;
width_chars: number;
xalign: number;
get_label(): string;
...
export class SimplePopover extends Gtk.Popover {constructor(config?: properties);
button_text: string;
message: string;
ready: boolean;
text: string;
...
export class Slider extends Gtk.Container {constructor(config?: properties);
...
export class StackList extends Gtk.Bin {constructor(config?: properties);
...
export class StateMachine extends GObject.Object {constructor(config?: properties);
state: string;
...
add_property(state: string, object: object | null, property: string, ___: unknown[]): void;
add_property_valist(state: string, object: object | null, property: string, var_args: any): void;
...
connect_object(state: string, source: object | null, detailed_signal: string, callback: GObject.Callback, user_data: object | null, flags: GObject.ConnectFlags): void;
create_action(name: string): Gio.Action;
get_state(): string;
is_state(state: string | null): boolean;
set_state(state: string): void;
static buildable_iface_init(iface: Gtk.BuildableIface): void;
}
export class Suggestion extends GObject.Object {constructor(config?: properties);
...
export class SuggestionButton extends Gtk.Stack {constructor(config?: properties);
readonly button: Gtk.Button;
readonly entry: SuggestionEntry;
get_button(): Gtk.Button;
get_entry(): SuggestionEntry;
}
export class SuggestionEntry extends Gtk.Entry {constructor(config?: properties);
...
export class SuggestionEntryBuffer extends Gtk.EntryBuffer {constructor(config?: properties);
suggestion: Suggestion;
clear(): void;
commit(): void;
get_suggestion(): Suggestion | null;
...
export class SuggestionPopover extends Gtk.Window {constructor(config?: properties);
model: Suggestion;
...
export class SuggestionRow extends ListBoxRow {constructor(config?: properties);
orientation: Gtk.Orientation;
suggestion: Suggestion;
get_suggestion(): Suggestion;
set_suggestion(suggestion: Suggestion): void;
}
export class Tab  {constructor(config?: properties);
active: boolean;
can_close: boolean;
edge: Gtk.PositionType;
style: TabStyle;
...
export class TabStrip extends Gtk.Box {constructor(config?: properties);
edge: Gtk.PositionType;
stack: Gtk.Stack;
style: TabStyle;
...
export class TaskCache extends GObject.Object {constructor(config?: properties);
...
export class ThemeManager extends GObject.Object {constructor(config?: properties);
add_resources(resource_path: string): void;
remove_resources(resource_path: string): void;
}
export class ThreeGrid extends Gtk.Container {constructor(config?: properties);
column_spacing: number;
row_spacing: number;
}
...
export class TreeBuilder extends GObject.InitiallyUnowned {constructor(config?: properties);
readonly tree: Tree;
get_tree(): Tree | null;
...
export class TreeNode extends GObject.InitiallyUnowned {constructor(config?: properties);
...
export class WidgetActionGroup  {constructor(config?: properties);
widget: Gtk.Widget;
...
readonly add_resources: unknown;
readonly remove_resources: unknown;
...
readonly get_fullscreen: unknown;
readonly set_fullscreen: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class BindingGroupClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class BoldingLabelClass  {constructor(config?: properties);
...
export class BoxTheatricClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class CenteringBinClass  {constructor(config?: properties);
}
export class ChildPropertyActionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ColumnLayoutClass  {constructor(config?: properties);
}
export class Counter  {constructor(config?: properties);
values: CounterValue;
category: string;
name: string;
description: string;
...
export class CounterArena  {constructor(config?: properties);
...
export class CounterValue  {constructor(config?: properties);
value: number;
padding: number[];
}
export class CountersWindowClass  {constructor(config?: properties);
...
export class CpuGraphClass  {constructor(config?: properties);
readonly parent_class: GraphViewClass;
}
export class CpuModelClass  {constructor(config?: properties);
readonly parent_class: GraphModelClass;
}
export class CssProviderClass  {constructor(config?: properties);
readonly parent_class: Gtk.CssProviderClass;
}
export class DirectoryModelClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DirectoryReaperClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DockBinClass  {constructor(config?: properties);
readonly create_edge: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockBinEdgeClass  {constructor(config?: properties);
readonly move_to_bin_child: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockInterface  {constructor(config?: properties);
}
export class DockItemInterface  {constructor(config?: properties);
readonly set_manager: unknown;
readonly get_manager: unknown;
readonly manager_set: unknown;
readonly present_child: unknown;
readonly update_visibility: unknown;
readonly get_child_visible: unknown;
readonly set_child_visible: unknown;
readonly get_title: unknown;
readonly get_icon_name: unknown;
readonly get_can_close: unknown;
readonly can_minimize: unknown;
readonly close: unknown;
readonly minimize: unknown;
readonly release: unknown;
readonly presented: unknown;
readonly ref_gicon: unknown;
readonly needs_attention: unknown;
}
export class DockManagerClass  {constructor(config?: properties);
readonly register_dock: unknown;
readonly unregister_dock: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockOverlayClass  {constructor(config?: properties);
readonly hide_edges: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockOverlayEdgeClass  {constructor(config?: properties);
readonly parent_class: BinClass;
}
export class DockPanedClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockRevealerClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockStackClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
}
export class DockTransientGrabClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DockWidgetClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class DockWindowClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class ElasticBinClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class EmptyStateClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
}
export class EntryBoxClass  {constructor(config?: properties);
readonly parent_class: Gtk.BoxClass;
}
export class FileChooserEntryClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class FileTransferClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _padding: object[];
}
export class FileTransferStat  {constructor(config?: properties);
...
export class FuzzyIndexBuilderClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class FuzzyIndexClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class FuzzyIndexCursorClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class FuzzyIndexMatchClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class FuzzyMutableIndex  {constructor(config?: properties);
...
export class FuzzyMutableIndexMatch  {constructor(config?: properties);
key: string;
value: object;
score: number;
id: number;
}
export class GraphColumnClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class GraphLineRendererClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class GraphModelClass  {constructor(config?: properties);
}
export class GraphModelIter  {constructor(config?: properties);
data: object[];
}
export class GraphRendererInterface  {constructor(config?: properties);
readonly render: unknown;
}
export class GraphViewClass  {constructor(config?: properties);
...
export class Heap  {constructor(config?: properties);
...
export class JoinedMenuClass  {constructor(config?: properties);
readonly parent_class: Gio.MenuModelClass;
}
...
export class ListModelFilterClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ListStoreAdapterClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
...
export class MenuManagerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class MultiPanedClass  {constructor(config?: properties);
readonly resize_drag_begin: unknown;
readonly resize_drag_end: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class PathBarClass  {constructor(config?: properties);
readonly parent_class: Gtk.BoxClass;
}
export class PathClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class PathElementClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
...
export class PillBoxClass  {constructor(config?: properties);
readonly parent_class: Gtk.EventBoxClass;
}
export class PreferencesBinClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
...
export class PreferencesEntryClass  {constructor(config?: properties);
readonly parent_class: PreferencesBinClass;
}
export class PreferencesFileChooserButtonClass  {constructor(config?: properties);
readonly parent_class: PreferencesBinClass;
}
export class PreferencesFlowBoxClass  {constructor(config?: properties);
readonly parent_class: ColumnLayoutClass;
}
export class PreferencesFontButtonClass  {constructor(config?: properties);
readonly parent_class: PreferencesBinClass;
}
export class PreferencesGroupClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
}
export class PreferencesInterface  {constructor(config?: properties);
readonly parent_interface: GObject.TypeInterface;
readonly set_page: unknown;
readonly add_page: unknown;
readonly add_group: unknown;
readonly add_list_group: unknown;
readonly add_radio: unknown;
readonly add_font_button: unknown;
readonly add_switch: unknown;
readonly add_spin_button: unknown;
readonly add_file_chooser: unknown;
readonly add_custom: unknown;
readonly remove_id: unknown;
readonly get_widget: unknown;
readonly add_table_row_va: unknown;
}
export class PreferencesPageClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
}
export class PreferencesSpinButtonClass  {constructor(config?: properties);
readonly parent_class: PreferencesBinClass;
}
export class PreferencesSwitchClass  {constructor(config?: properties);
readonly parent_class: PreferencesBinClass;
}
export class PreferencesViewClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
readonly _reserved: object[];
}
export class PriorityBoxClass  {constructor(config?: properties);
readonly parent_class: Gtk.BoxClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class ProgressButtonClass  {constructor(config?: properties);
...
export class ProgressIconClass  {constructor(config?: properties);
readonly parent_class: Gtk.DrawingAreaClass;
}
export class ProgressMenuButtonClass  {constructor(config?: properties);
readonly parent_class: Gtk.MenuButtonClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class PropertiesGroupClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class RadioBoxClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
...
export class ReadOnlyListModelClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class RecursiveFileMonitorClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class Ring  {constructor(config?: properties);
...
export class SettingsFlagActionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class SettingsSandwichClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ShortcutAccelDialogClass  {constructor(config?: properties);
readonly parent_class: Gtk.DialogClass;
}
export class ShortcutChord  {constructor(config?: properties);
...
export class ShortcutChordTable  {constructor(config?: properties);
...
size(): number;
static _new(): ShortcutChordTable;
}
export class ShortcutContextClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ShortcutControllerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ShortcutEntry  {constructor(config?: properties);
command: string;
phase: ShortcutPhase;
...
export class ShortcutManagerClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class ShortcutModelClass  {constructor(config?: properties);
readonly parent_class: Gtk.TreeStoreClass;
}
export class ShortcutSimpleLabelClass  {constructor(config?: properties);
readonly parent_class: Gtk.BoxClass;
}
export class ShortcutThemeClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class ShortcutThemeEditorClass  {constructor(config?: properties);
readonly parent_class: Gtk.BinClass;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
...
export class ShortcutTooltipClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
...
export class SignalGroupClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class SimpleLabelClass  {constructor(config?: properties);
readonly parent_class: Gtk.WidgetClass;
}
export class SimplePopoverClass  {constructor(config?: properties);
readonly activate: unknown;
readonly insert_text: unknown;
readonly changed: unknown;
}
export class SliderClass  {constructor(config?: properties);
}
export class StackListClass  {constructor(config?: properties);
readonly row_activated: unknown;
readonly header_activated: unknown;
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class StateMachineClass  {constructor(config?: properties);
}
export class SuggestionButtonClass  {constructor(config?: properties);
readonly parent_class: Gtk.StackClass;
readonly _reserved: object[];
}
export class SuggestionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly suggest_suffix: unknown;
readonly replace_typed_text: unknown;
readonly get_icon: unknown;
readonly get_icon_surface: unknown;
readonly _reserved3: object;
readonly _reserved4: object;
}
export class SuggestionEntryBufferClass  {constructor(config?: properties);
...
export class SuggestionEntryClass  {constructor(config?: properties);
readonly parent_class: Gtk.EntryClass;
readonly hide_suggestions: unknown;
readonly show_suggestions: unknown;
readonly move_suggestion: unknown;
readonly suggestion_activated: unknown;
readonly suggestion_selected: unknown;
readonly _reserved: object[];
}
export class SuggestionPopoverClass  {constructor(config?: properties);
readonly parent_class: Gtk.WindowClass;
}
export class SuggestionRowClass  {constructor(config?: properties);
readonly parent_class: ListBoxRowClass;
readonly _reserved: object[];
}
export class TabClass  {constructor(config?: properties);
readonly parent_class: BinClass;
}
export class TabStripClass  {constructor(config?: properties);
readonly _reserved1: object;
readonly _reserved2: object;
readonly _reserved3: object;
readonly _reserved4: object;
...
export class TaskCacheClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ThemeManagerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ThreeGridClass  {constructor(config?: properties);
...
export class TreeBuilderClass  {constructor(config?: properties);
readonly parent_class: GObject.InitiallyUnownedClass;
readonly added: unknown;
readonly removed: unknown;
readonly build_node: unknown;
readonly build_children: unknown;
readonly node_activated: unknown;
readonly node_selected: unknown;
readonly node_unselected: unknown;
readonly node_popup: unknown;
readonly node_expanded: unknown;
readonly node_collapsed: unknown;
readonly node_draggable: unknown;
readonly node_droppable: unknown;
readonly drag_data_get: unknown;
readonly drag_node_received: unknown;
readonly drag_data_received: unknown;
readonly drag_node_delete: unknown;
readonly cell_data_func: unknown;
readonly _padding: object[];
}
...
export class TreeNodeClass  {constructor(config?: properties);
readonly parent_class: GObject.InitiallyUnownedClass;
}
export class Trie  {constructor(config?: properties);
destroy(): void;
insert(key: string, value: object | null): void;
...
export class WidgetActionGroupClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class _GraphColumnClass  {constructor(config?: properties);
}
...
add_table_row(page_name: string, group_name: string, first_widget: Gtk.Widget, ___: unknown[]): number;
