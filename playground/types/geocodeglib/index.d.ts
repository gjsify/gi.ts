...
export class BoundingBox extends GObject.Object {constructor(config?: properties);
bottom: number;
left: number;
right: number;
top: number;
...
export class Forward extends GObject.Object {constructor(config?: properties);
answer_count: number;
bounded: boolean;
...
export class Location extends GObject.Object {constructor(config?: properties);
accuracy: number;
altitude: number;
crs: LocationCRS;
description: string;
...
export class MockBackend extends GObject.Object {constructor(config?: properties);
...
export class Nominatim extends GObject.Object {constructor(config?: properties);
base_url: string;
...
export class Place extends GObject.Object {constructor(config?: properties);
...
export class Reverse extends GObject.Object {constructor(config?: properties);
...
export class BackendInterface  {constructor(config?: properties);
readonly g_iface: GObject.TypeInterface;
readonly forward_search: unknown;
readonly forward_search_async: unknown;
readonly forward_search_finish: unknown;
readonly reverse_resolve: unknown;
readonly reverse_resolve_async: unknown;
readonly reverse_resolve_finish: unknown;
readonly padding: object[];
}
export class BoundingBoxClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class BoundingBoxPrivate  {constructor(config?: properties);
}
export class ForwardClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ForwardPrivate  {constructor(config?: properties);
}
export class LocationClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class LocationPrivate  {constructor(config?: properties);
}
export class MockBackendClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class MockBackendQuery  {constructor(config?: properties);
params: GLib.HashTable;
is_forward: boolean;
results: GLib.List;
error: GLib.Error;
}
export class NominatimClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly query: unknown;
readonly query_async: unknown;
readonly query_finish: unknown;
}
export class PlaceClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class PlacePrivate  {constructor(config?: properties);
}
export class ReverseClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ReversePrivate  {constructor(config?: properties);
}
