...
start_video_recording(filename: unknown): void;
stop(): void;
...
export class CameraDevice extends GObject.Object {constructor(config?: properties);
device: Gst.Device;
name: string;
...
export class CameraDeviceMonitor extends GObject.Object {constructor(config?: properties);
...
export class Effect extends GObject.Object {constructor(config?: properties);
...
static load_from_file(filename: unknown): Effect;
}
export class FileUtil extends GObject.Object {constructor(config?: properties);
get_new_media_filename(mode: MediaMode): unknown;
get_photo_path(): unknown;
get_video_path(): unknown;
reset_burst(): void;
}
...
export class CameraDeviceMonitorClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly added: unknown;
readonly removed: unknown;
}
export class CameraDeviceMonitorPrivate  {constructor(config?: properties);
}
...
export class FileUtilClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class VideoFormat  {constructor(config?: properties);
width: number;
height: number;
}