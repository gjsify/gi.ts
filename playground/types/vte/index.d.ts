 ...
 */
export function get_user_shell(): unknown;
/**
 ...
 */
export function set_test_flags(flags: number): void;
...
export class Pty extends GObject.Object {constructor(config?: properties);
fd: number;
...
spawn_async(working_directory: string | null, argv: unknown[], envv: unknown[] | null, spawn_flags: GLib.SpawnFlags, child_setup: GLib.SpawnChildSetupFunc | null, child_setup_data: object | null, child_setup_data_destroy: GLib.DestroyNotify, timeout: number, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null, user_data: object | null): void;
spawn_finish(result: Gio.AsyncResult): [boolean, GLib.Pid | null];
}
export class Terminal extends Gtk.Widget {constructor(config?: properties);
allow_bold: boolean;
...
spawn_async(pty_flags: PtyFlags, working_directory: string | null, argv: unknown[], envv: unknown[] | null, spawn_flags_: GLib.SpawnFlags, child_setup: GLib.SpawnChildSetupFunc | null, child_setup_data: object | null, child_setup_data_destroy: GLib.DestroyNotify, timeout: number, cancellable: Gio.Cancellable | null, callback: TerminalSpawnAsyncCallback | null, user_data: object | null): void;
spawn_sync(pty_flags: PtyFlags, working_directory: string | null, argv: unknown[], envv: unknown[] | null, spawn_flags: GLib.SpawnFlags, child_setup: GLib.SpawnChildSetupFunc | null, child_setup_data: object | null, cancellable: Gio.Cancellable | null): [boolean, GLib.Pid | null];
unselect_all(): void;
...
export class CharAttributes  {constructor(config?: properties);
readonly row: number;
...
export class PtyClass  {constructor(config?: properties);
}
...
export class TerminalClass  {constructor(config?: properties);
readonly parent_class: Gtk.WidgetClass;
readonly eof: unknown;
readonly child_exited: unknown;
readonly encoding_changed: unknown;
readonly char_size_changed: unknown;
readonly window_title_changed: unknown;
readonly icon_title_changed: unknown;
readonly selection_changed: unknown;
readonly contents_changed: unknown;
readonly cursor_moved: unknown;
readonly commit: unknown;
readonly deiconify_window: unknown;
readonly iconify_window: unknown;
readonly raise_window: unknown;
readonly lower_window: unknown;
readonly refresh_window: unknown;
readonly restore_window: unknown;
readonly maximize_window: unknown;
readonly resize_window: unknown;
readonly move_window: unknown;
readonly increase_font_size: unknown;
readonly decrease_font_size: unknown;
readonly text_modified: unknown;
readonly text_inserted: unknown;
readonly text_deleted: unknown;
readonly text_scrolled: unknown;
readonly copy_clipboard: unknown;
readonly paste_clipboard: unknown;
readonly bell: unknown;
readonly padding: object[];
readonly priv: TerminalClassPrivate;
}
export class TerminalClassPrivate  {constructor(config?: properties);
}