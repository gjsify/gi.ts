...
export class XConfigureEvent  {constructor(config?: properties);
}
export class XImage  {constructor(config?: properties);
}
export class XFontStruct  {constructor(config?: properties);
}
export class XTrapezoid  {constructor(config?: properties);
}
export class XVisualInfo  {constructor(config?: properties);
}
export class XWindowAttributes  {constructor(config?: properties);
}
export class XEvent  {constructor(config?: properties);
}