 ...
 * 
 */
export function glibtop_get_netload(buf: glibtop_netload, _interface: string): void;
/**
 * 
 */
 ...
 * 
 */
export function glibtop_init_r(features: number, flags: number): [glibtop, glibtop];
/**
 * 
 */
export function glibtop_init_s(features: number, flags: number): [glibtop, glibtop];
/**
 * 
 */
...
export class glibtop  {constructor(config?: properties);
flags: number;
method: number;
error_method: number;
input: number[];
...
get_proc_argv_l(buf: glibtop_proc_args, pid: number, max_len: number): string[];
...
get_proc_wd_l(buf: glibtop_proc_wd, pid: number): string[];
get_proc_wd_s(buf: glibtop_proc_wd, pid: number): string[];
...
static init_s(features: number, flags: number): [glibtop, glibtop];
static internet_addr(host: string): number;
static make_connection(hostarg: string, portarg: number, s: number): number;
}
export class glibtop_command  {constructor(config?: properties);
command: number;
size: number;
data_size: number;
parameter: number[];
}
export class glibtop_cpu  {constructor(config?: properties);
flags: number;
total: number;
user: number;
nice: number;
...
export class glibtop_entry  {constructor(config?: properties);
labels: object[];
values: GLib.HashTable;
descriptions: GLib.HashTable;
}
export class glibtop_fsusage  {constructor(config?: properties);
flags: number;
blocks: number;
bfree: number;
bavail: number;
...
export class glibtop_loadavg  {constructor(config?: properties);
flags: number;
loadavg: number[];
nr_running: number;
nr_tasks: number;
...
export class glibtop_machine  {constructor(config?: properties);
}
export class glibtop_map_entry  {constructor(config?: properties);
flags: number;
start: number;
end: number;
offset: number;
...
export class glibtop_mem  {constructor(config?: properties);
flags: number;
total: number;
used: number;
free: number;
...
export class glibtop_mountentry  {constructor(config?: properties);
dev: number;
devname: number[];
mountdir: number[];
type: number[];
}
export class glibtop_mountlist  {constructor(config?: properties);
flags: number;
number: number;
total: number;
size: number;
}
export class glibtop_msg_limits  {constructor(config?: properties);
flags: number;
msgpool: number;
msgmap: number;
msgmax: number;
...
export class glibtop_netlist  {constructor(config?: properties);
flags: number;
number: number;
}
export class glibtop_netload  {constructor(config?: properties);
flags: number;
if_flags: number;
mtu: number;
subnet: number;
...
export class glibtop_open_files_entry  {constructor(config?: properties);
fd: number;
type: number;
}
export class glibtop_ppp  {constructor(config?: properties);
flags: number;
state: number;
bytes_in: number;
bytes_out: number;
}
export class glibtop_proc_affinity  {constructor(config?: properties);
flags: number;
number: number;
all: boolean;
}
export class glibtop_proc_args  {constructor(config?: properties);
flags: number;
size: number;
}
export class glibtop_proc_io  {constructor(config?: properties);
flags: number;
disk_rchar: number;
disk_wchar: number;
disk_rbytes: number;
...
export class glibtop_proc_kernel  {constructor(config?: properties);
flags: number;
k_flags: number;
min_flt: number;
maj_flt: number;
...
export class glibtop_proc_map  {constructor(config?: properties);
flags: number;
number: number;
total: number;
size: number;
}
export class glibtop_proc_mem  {constructor(config?: properties);
flags: number;
size: number;
vsize: number;
resident: number;
...
export class glibtop_proc_open_files  {constructor(config?: properties);
flags: number;
number: number;
total: number;
size: number;
}
export class glibtop_proc_segment  {constructor(config?: properties);
flags: number;
text_rss: number;
shlib_rss: number;
data_rss: number;
...
export class glibtop_proc_signal  {constructor(config?: properties);
flags: number;
signal: number[];
blocked: number[];
sigignore: number[];
...
export class glibtop_proc_state  {constructor(config?: properties);
flags: number;
cmd: number[];
state: number;
uid: number;
...
export class glibtop_proc_time  {constructor(config?: properties);
...
export class glibtop_proc_uid  {constructor(config?: properties);
flags: number;
uid: number;
euid: number;
gid: number;
...
export class glibtop_proc_wd  {constructor(config?: properties);
flags: number;
number: number;
root: number[];
exe: number[];
}
export class glibtop_proclist  {constructor(config?: properties);
flags: number;
number: number;
total: number;
size: number;
}
export class glibtop_response  {constructor(config?: properties);
offset: number;
size: number;
data_size: number;
u: glibtop_response_union;
}
export class glibtop_sem_limits  {constructor(config?: properties);
flags: number;
semmap: number;
semmni: number;
semmns: number;
...
export class glibtop_shm_limits  {constructor(config?: properties);
flags: number;
shmmax: number;
shmmin: number;
shmmni: number;
...
export class glibtop_signame  {constructor(config?: properties);
number: number;
name: string;
label: string;
}
export class glibtop_swap  {constructor(config?: properties);
flags: number;
total: number;
used: number;
free: number;
...
export class glibtop_sysdeps  {constructor(config?: properties);
flags: number;
features: number;
cpu: number;
mem: number;
...
export class glibtop_sysinfo  {constructor(config?: properties);
flags: number;
ncpu: number;
cpuinfo: glibtop_entry[];
}
export class glibtop_uptime  {constructor(config?: properties);
flags: number;
uptime: number;
idletime: number;
boot_time: number;
}
export class glibtop_response_union  {constructor(config?: properties);
data: glibtop_union;
sysdeps: glibtop_sysdeps;
}
export class glibtop_union  {constructor(config?: properties);
cpu: glibtop_cpu;
mem: glibtop_mem;
swap: glibtop_swap;
