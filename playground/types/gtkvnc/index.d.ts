...
export class CairoFramebuffer extends GVnc.BaseFramebuffer {constructor(config?: properties);
surface: object;
get_surface(): cairo.Surface;
}
export class Display extends Gtk.DrawingArea {constructor(config?: properties);
...
export class CairoFramebufferClass  {constructor(config?: properties);
readonly parent_class: GVnc.BaseFramebufferClass;
readonly _vnc_reserved: object[];
}
export class CairoFramebufferPrivate  {constructor(config?: properties);
}
...
export class DisplayPrivate  {constructor(config?: properties);
}
