...
export class FeedAtomFormatter extends FeedFormatter {constructor(config?: properties);
}
export class FeedChannel extends GObject.Object {constructor(config?: properties);
...
export class FeedEnclosure extends GObject.Object {constructor(config?: properties);
fetch(): Gio.File;
fetch_async(callback: Gio.AsyncReadyCallback | null, user_data: object | null): void;
...
export class FeedFormatter  {constructor(config?: properties);
...
export class FeedItem extends GObject.Object {constructor(config?: properties);
...
export class FeedParser extends GObject.Object {constructor(config?: properties);
parse(feed: FeedChannel, doc: libxml2.DocPtr): GLib.List;
parse_channel(feed: FeedChannel, doc: libxml2.DocPtr): void;
}
export class FeedRssFormatter extends FeedFormatter {constructor(config?: properties);
}
export class FeedsGroup extends GObject.Object {constructor(config?: properties);
export_file(channels: GLib.List, format: string, uri: string): boolean;
get_formats(): GLib.List;
parse_file(path: string): GLib.List;
}
export class FeedsPool extends GObject.Object {constructor(config?: properties);
...
vfunc_feed_ready(feed: FeedChannel, items: GLib.List): void;
}
export class FeedsPublisher extends GObject.Object {constructor(config?: properties);
...
export class FeedsStore  {constructor(config?: properties);
...
export class FeedsSubscriber extends GObject.Object {constructor(config?: properties);
...
export class FeedAtomFormatterClass  {constructor(config?: properties);
}
export class FeedAtomFormatterPrivate  {constructor(config?: properties);
}
export class FeedChannelClass  {constructor(config?: properties);
}
export class FeedChannelPrivate  {constructor(config?: properties);
}
export class FeedEnclosureClass  {constructor(config?: properties);
}
export class FeedEnclosurePrivate  {constructor(config?: properties);
}
export class FeedFormatterClass  {constructor(config?: properties);
readonly format: unknown;
}
export class FeedFormatterPrivate  {constructor(config?: properties);
}
export class FeedItemClass  {constructor(config?: properties);
}
export class FeedItemPrivate  {constructor(config?: properties);
}
export class FeedParserClass  {constructor(config?: properties);
}
export class FeedParserPrivate  {constructor(config?: properties);
}
export class FeedRssFormatterClass  {constructor(config?: properties);
}
export class FeedRssFormatterPrivate  {constructor(config?: properties);
}
export class FeedsGroupClass  {constructor(config?: properties);
}
export class FeedsGroupPrivate  {constructor(config?: properties);
}
export class FeedsPoolClass  {constructor(config?: properties);
readonly feed_fetching: unknown;
readonly feed_ready: unknown;
}
export class FeedsPoolPrivate  {constructor(config?: properties);
}
export class FeedsPublisherClass  {constructor(config?: properties);
readonly new_subscription: unknown;
readonly delete_subscription: unknown;
}
export class FeedsPublisherPrivate  {constructor(config?: properties);
}
export class FeedsStoreClass  {constructor(config?: properties);
readonly get_channels: unknown;
readonly get_items_by_channel: unknown;
readonly has_item: unknown;
readonly add_item_in_channel: unknown;
}
export class FeedsStorePrivate  {constructor(config?: properties);
}
export class FeedsSubscriberClass  {constructor(config?: properties);
readonly notification_received: unknown;
}
export class FeedsSubscriberPrivate  {constructor(config?: properties);
}
export class Person  {constructor(config?: properties);
get_email(): string;
get_name(): string;
get_uri(): string;
ref(): Person;
