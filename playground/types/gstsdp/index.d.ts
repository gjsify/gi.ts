...
export class MIKEYDecryptInfo  {constructor(config?: properties);
}
export class MIKEYEncryptInfo  {constructor(config?: properties);
}
export class MIKEYMapSRTP  {constructor(config?: properties);
policy: number;
ssrc: number;
roc: number;
}
export class MIKEYMessage  {constructor(config?: properties);
...
export class MIKEYPayload  {constructor(config?: properties);
...
export class MIKEYPayloadKEMAC  {constructor(config?: properties);
pt: MIKEYPayload;
enc_alg: MIKEYEncAlg;
mac_alg: MIKEYMacAlg;
subpayloads: object[];
}
export class MIKEYPayloadKeyData  {constructor(config?: properties);
pt: MIKEYPayload;
...
export class MIKEYPayloadPKE  {constructor(config?: properties);
pt: MIKEYPayload;
C: MIKEYCacheType;
data_len: number;
data: number;
}
export class MIKEYPayloadRAND  {constructor(config?: properties);
pt: MIKEYPayload;
len: number;
rand: number;
}
export class MIKEYPayloadSP  {constructor(config?: properties);
pt: MIKEYPayload;
policy: number;
proto: MIKEYSecProto;
params: object[];
}
export class MIKEYPayloadSPParam  {constructor(config?: properties);
type: number;
len: number;
val: number;
}
export class MIKEYPayloadT  {constructor(config?: properties);
pt: MIKEYPayload;
type: MIKEYTSType;
ts_value: number;
}
export class SDPAttribute  {constructor(config?: properties);
key: string;
value: string;
clear(): SDPResult;
set(key: string, value: string | null): SDPResult;
}
export class SDPBandwidth  {constructor(config?: properties);
bwtype: string;
bandwidth: number;
clear(): SDPResult;
set(bwtype: string, bandwidth: number): SDPResult;
}
export class SDPConnection  {constructor(config?: properties);
nettype: string;
addrtype: string;
address: string;
ttl: number;
...
export class SDPKey  {constructor(config?: properties);
type: string;
data: string;
}
export class SDPMedia  {constructor(config?: properties);
media: string;
port: number;
num_ports: number;
proto: string;
...
export class SDPMessage  {constructor(config?: properties);
version: string;
origin: SDPOrigin;
session_name: string;
information: string;
...
export class SDPOrigin  {constructor(config?: properties);
username: string;
sess_id: string;
sess_version: string;
nettype: string;
...
export class SDPTime  {constructor(config?: properties);
start: string;
stop: string;
repeat: object[];
clear(): SDPResult;
...
export class SDPZone  {constructor(config?: properties);
time: string;
typed_time: string;
clear(): SDPResult;
