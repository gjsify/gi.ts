...
export class Configuration  {constructor(config?: properties);
...
export class Indicator extends Gtk.Notebook {constructor(config?: properties);
reinit_ui(): void;
...
export class KeyboardDrawing extends Gtk.DrawingArea {constructor(config?: properties);
...
set_keyboard(names: unknown): boolean;
...
export class Status extends Gtk.StatusIcon {constructor(config?: properties);
reinit_ui(): void;
static get_group_names(): string[];
static get_image_filename(group: number): string;
static get_xkl_engine(): Xkl.Engine;
}
export class ConfigurationClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ConfigurationPrivate  {constructor(config?: properties);
}
export class DesktopConfig  {constructor(config?: properties);
...
export class IndicatorClass  {constructor(config?: properties);
readonly parent_class: Gtk.NotebookClass;
readonly reinit_ui: unknown;
}
export class IndicatorConfig  {constructor(config?: properties);
...
export class IndicatorPrivate  {constructor(config?: properties);
}
export class KeyboardConfig  {constructor(config?: properties);
model: string;
...
export class KeyboardDrawingClass  {constructor(config?: properties);
readonly parent_class: Gtk.DrawingAreaClass;
readonly bad_keycode: unknown;
}
export class KeyboardDrawingDoodad  {constructor(config?: properties);
readonly type: KeyboardDrawingItemType;
readonly origin_x: number;
readonly origin_y: number;
readonly angle: number;
readonly priority: number;
readonly doodad: unknown;
readonly on: boolean;
}
export class KeyboardDrawingGroupLevel  {constructor(config?: properties);
group: number;
level: number;
}
export class KeyboardDrawingItem  {constructor(config?: properties);
readonly type: KeyboardDrawingItemType;
readonly origin_x: number;
readonly origin_y: number;
readonly angle: number;
...
export class KeyboardDrawingKey  {constructor(config?: properties);
readonly type: KeyboardDrawingItemType;
readonly origin_x: number;
readonly origin_y: number;
readonly angle: number;
readonly priority: number;
readonly xkbkey: unknown;
readonly pressed: boolean;
readonly keycode: number;
}
export class KeyboardDrawingRenderContext  {constructor(config?: properties);
cr: cairo.Context;
angle: number;
layout: Pango.Layout;
...
export class StatusClass  {constructor(config?: properties);
readonly parent_class: Gtk.NotebookClass;
}
export class StatusPrivate  {constructor(config?: properties);
}