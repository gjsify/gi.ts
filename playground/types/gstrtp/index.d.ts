 ...
 * 
 */
export function rtp_source_meta_api_get_type(): unknown;
/**
 * 
 */
...
export class RTPBaseAudioPayload  {constructor(config?: properties);
buffer_list: boolean;
...
export class RTPBaseDepayload  {constructor(config?: properties);
source_info: boolean;
...
export class RTPBasePayload  {constructor(config?: properties);
max_ptime: number;
min_ptime: number;
mtu: number;
...
set_outcaps(fieldname: string, ___: unknown[]): boolean;
set_source_info_enabled(enable: boolean): void;
}
export class RTCPBuffer  {constructor(config?: properties);
buffer: Gst.Buffer;
...
export class RTCPPacket  {constructor(config?: properties);
rtcp: RTCPBuffer;
offset: number;
...
export class RTPBaseAudioPayloadClass  {constructor(config?: properties);
readonly parent_class: RTPBasePayloadClass;
readonly _gst_reserved: object[];
}
export class RTPBaseAudioPayloadPrivate  {constructor(config?: properties);
}
export class RTPBaseDepayloadClass  {constructor(config?: properties);
readonly parent_class: Gst.ElementClass;
readonly set_caps: unknown;
readonly process: unknown;
readonly packet_lost: unknown;
readonly handle_event: unknown;
readonly process_rtp_packet: unknown;
readonly _gst_reserved: object[];
}
export class RTPBaseDepayloadPrivate  {constructor(config?: properties);
}
export class RTPBasePayloadClass  {constructor(config?: properties);
readonly parent_class: Gst.ElementClass;
readonly get_caps: unknown;
readonly set_caps: unknown;
readonly handle_buffer: unknown;
readonly sink_event: unknown;
readonly src_event: unknown;
readonly query: unknown;
readonly _gst_reserved: object[];
}
export class RTPBasePayloadPrivate  {constructor(config?: properties);
}
export class RTPBuffer  {constructor(config?: properties);
buffer: Gst.Buffer;
state: number;
data: object[];
size: number[];
...
get_extension_data(): [boolean, number,number[],number];
...
export class RTPPayloadInfo  {constructor(config?: properties);
payload_type: number;
media: string;
...
export class RTPSourceMeta  {constructor(config?: properties);
meta: Gst.Meta;
ssrc: number;
ssrc_valid: boolean;
csrc: number[];
