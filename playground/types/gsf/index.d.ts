 ...
 */
export function iconv_close(handle: GLib.IConv): void;
/**
 ...
 */
export function msole_iconv_open_codepage_for_export(codepage_to: number): GLib.IConv;
/**
 * NOTE: skipped since GIConv is not exported to introspection.
 */
export function msole_iconv_open_codepage_for_import(to: string, codepage: number): GLib.IConv;
/**
 * NOTE: skipped since GIConv is not exported to introspection.
 */
export function msole_iconv_open_codepages_for_export(codepage_to: number, from: string): GLib.IConv;
/**
 * NOTE: skipped since GIConv is not exported to introspection.
 */
export function msole_iconv_open_for_export(): GLib.IConv;
/**
 * NOTE: skipped since GIConv is not exported to introspection.
 */
export function msole_iconv_open_for_import(codepage: number): GLib.IConv;
/**
 * 
 */
 ...
 */
export function odf_get_version(): unknown;
/**
 * Gives the ODF version used by libgsf when writing Open Document files.
 */
 ...
 * NOTE: skipping because gsf_open_pkg_rel_get_type() does not return a G
 * Type.
 */
export function open_pkg_lookup_rel_by_id(opkg: Input, id: string): OpenPkgRel;
/**
 * New in 1.14.6
 ...
 * Type.
 */
export function open_pkg_lookup_rel_by_type(opkg: Input, type: string): OpenPkgRel;
/**
 * 
 */
 ...
 * 
 */
export function property_settings_collect(object_type: unknown, p_params: GObject.Parameter, p_n_params: number, first_property_name: string, ___: unknown[]): void;
/**
 * This function builds a GParameter array suitable for g_object_newv.
 */
export function property_settings_collect_valist(object_type: unknown, p_params: GObject.Parameter, p_n_params: number, first_property_name: string, var_args: any): void;
/**
 * 
 */
 ...
 */
export function xml_gvalue_from_str(res: GObject.Value, t: unknown, str: string): boolean;
/**
 * Create a libxml2 pull style parser context wrapper around gsf input @i
 * nput.
 * This signature will probably change to supply a SAX structure.
 * <note>This adds a reference to @input.</note>
 * <note>A simple wrapper around a cleaner implementation that will fold 
 * in
 ...
 */
export function xml_parser_context(input: Input): unknown | null;
/**
 * 
 */
...
export class Blob extends GObject.Object {constructor(config?: properties);
get_size(): number;
peek_data(): object | null;
}
export class ClipData extends GObject.Object {constructor(config?: properties);
get_data_blob(): Blob;
get_format(): ClipFormat;
get_windows_clipboard_format(): ClipFormatWindows;
peek_real_data(ret_size: number): object | null;
}
export class DocMetaData extends GObject.Object {constructor(config?: properties);
...
export class DocPropVector extends GObject.Object {constructor(config?: properties);
append(value: GObject.Value): void;
as_string(): string;
}
export class Infile  {constructor(config?: properties);
child_by_aname(names: string[]): Input;
child_by_index(i: number): Input;
child_by_name(name: string): Input;
child_by_vaname(names: any): Input;
child_by_vname(___: unknown[]): Input;
name_by_index(i: number): string | null;
num_children(): number;
}
export class InfileMSOle extends Infile {constructor(config?: properties);
get_class_id(res: number): boolean;
}
export class InfileMSVBA extends Infile {constructor(config?: properties);
get_modules(): GLib.HashTable | null;
steal_modules(): GLib.HashTable | null;
}
export class InfileStdio extends Infile {constructor(config?: properties);
}
export class InfileTar extends Infile {constructor(config?: properties);
source: Input;
}
export class InfileZip extends Infile {constructor(config?: properties);
readonly compression_level: number;
internal_parent: InfileZip;
source: Input;
}
export class Input extends GObject.Object {constructor(config?: properties);
...
name(): string;
read(num_bytes: number, optional_buffer: number[] | null): number[] | null;
...
vfunc_Read(num_bytes: number, optional_buffer: number[] | null): number[] | null;
vfunc_Seek(offset: gsf_off_t, whence: GLib.SeekType): boolean;
static error_id(): GLib.Quark;
}
export class InputGZip extends Input {constructor(config?: properties);
raw: boolean;
source: Input;
uncompressed_size: number;
}
export class InputGio extends Input {constructor(config?: properties);
static new_for_path(path: string): Input;
static new_for_uri(uri: string): Input;
}
export class InputHTTP extends Input {constructor(config?: properties);
content_type: string;
url: string;
get_content_type(): string;
get_url(): string;
}
export class InputMemory extends Input {constructor(config?: properties);
...
export class InputProxy extends Input {constructor(config?: properties);
static new_section(source: Input, offset: gsf_off_t, size: gsf_off_t): Input;
}
export class InputStdio extends Input {constructor(config?: properties);
static new_FILE(filename: string, file: object | null, keep_open: boolean): Input;
}
export class InputTextline extends Input {constructor(config?: properties);
ascii_gets(): number[] | null;
utf8_gets(): number[] | null;
}
export class ODFOut  {constructor(config?: properties);
odf_version: number;
...
export class Outfile  {constructor(config?: properties);
new_child(name: string, is_dir: boolean): Output;
new_child_full(name: string, is_dir: boolean, first_property_name: string, ___: unknown[]): Output;
new_child_varg(name: string, is_dir: boolean, first_property_name: string, args: any): Output;
open_pkg_add_rel(name: string, content_type: string, parent: Outfile, type: string): Output;
}
export class OutfileMSOle extends Outfile {constructor(config?: properties);
...
export class OutfileOpenPkg extends Outfile {constructor(config?: properties);
content_type: string;
is_dir: boolean;
sink: Outfile;
...
export class OutfileStdio extends Outfile {constructor(config?: properties);
static new_full(root: string, err: GLib.Error | null, first_property_name: string, ___: unknown[]): Outfile;
static new_valist(root: string, err: GLib.Error | null, first_property_name: string, var_args: any): Outfile;
}
export class OutfileZip extends Outfile {constructor(config?: properties);
...
is_closed(): boolean;
name(): string | null;
printf(format: string, ___: unknown[]): boolean;
puts(line: string): boolean;
seek(offset: gsf_off_t, whence: GLib.SeekType): boolean;
set_container(container: Outfile | null): boolean;
set_error(code: number, format: string, ___: unknown[]): boolean;
set_modtime(modtime: GLib.DateTime | null): boolean;
set_name(name: string | null): boolean;
set_name_from_filename(filename: string | null): boolean;
size(): gsf_off_t;
tell(): gsf_off_t;
vprintf(format: string, args: any): gsf_off_t;
...
export class OutputBzip extends Output {constructor(config?: properties);
}
export class OutputCsv  {constructor(config?: properties);
eol: string;
quote: string;
...
export class OutputGZip extends Output {constructor(config?: properties);
raw: boolean;
sink: Output;
}
export class OutputGio extends Output {constructor(config?: properties);
static new_for_path(path: string): Output;
static new_for_uri(uri: string): Output;
}
export class OutputIOChannel extends Output {constructor(config?: properties);
}
export class OutputIconv extends Output {constructor(config?: properties);
fallback: string;
input_charset: string;
output_charset: string;
sink: Output;
}
export class OutputMemory extends Output {constructor(config?: properties);
get_bytes(): number[] | null;
}
export class OutputStdio extends Output {constructor(config?: properties);
static new_FILE(filename: string, file: object | null, keep_open: boolean): Output;
static new_full(filename: string, err: GLib.Error | null, first_property_name: string, ___: unknown[]): Output;
static new_valist(filename: string, err: GLib.Error, first_property_name: string, var_args: any): Output;
}
export class SharedMemory extends GObject.Object {constructor(config?: properties);
static mmapped_new(buf: object | null, size: gsf_off_t): SharedMemory;
}
export class StructuredBlob  {constructor(config?: properties);
write(container: Outfile): boolean;
static read(input: Input): StructuredBlob;
}
export class XMLOut extends GObject.Object {constructor(config?: properties);
...
add_enum(id: string | null, etype: unknown, val: number): void;
...
export class BlobClass  {constructor(config?: properties);
}
export class BlobPrivate  {constructor(config?: properties);
}
export class ClipDataClass  {constructor(config?: properties);
}
export class ClipDataPrivate  {constructor(config?: properties);
}
export class DocProp  {constructor(config?: properties);
dump(): void;
free(): void;
...
export class InfileClass  {constructor(config?: properties);
readonly input_class: InputClass;
readonly num_children: unknown;
readonly name_by_index: unknown;
readonly child_by_index: unknown;
readonly child_by_name: unknown;
}
export class InputClass  {constructor(config?: properties);
readonly g_object_class: GObject.ObjectClass;
readonly Dup: unknown;
readonly Read: unknown;
readonly Seek: unknown;
readonly OpenSibling: unknown;
readonly _gsf_reserved0: unknown;
readonly _gsf_reserved1: unknown;
readonly _gsf_reserved2: unknown;
readonly _gsf_reserved3: unknown;
}
export class MSOleSortingKey  {constructor(config?: properties);
cmp(b: MSOleSortingKey): number;
free(): void;
}
export class ODFOutClass  {constructor(config?: properties);
readonly base: XMLOutClass;
readonly _gsf_reserved1: unknown;
readonly _gsf_reserved2: unknown;
readonly _gsf_reserved3: unknown;
readonly _gsf_reserved4: unknown;
}
export class OpenPkgRel  {constructor(config?: properties);
get_target(): string;
get_type(): string;
is_extern(): boolean;
}
export class OpenPkgRels  {constructor(config?: properties);
}
export class OutfileClass  {constructor(config?: properties);
readonly output_class: OutputClass;
readonly new_child: unknown;
}
export class OutputClass  {constructor(config?: properties);
readonly g_object_class: GObject.ObjectClass;
readonly Close: unknown;
readonly Seek: unknown;
readonly Write: unknown;
readonly Vprintf: unknown;
}
export class OutputCsvClass  {constructor(config?: properties);
readonly output_class: OutputClass;
}
export class OutputIconvClass  {constructor(config?: properties);
readonly output_class: OutputClass;
}
export class Timestamp  {constructor(config?: properties);
as_string(): string;
copy(): Timestamp;
...
export class XMLBlob  {constructor(config?: properties);
}
export class XMLIn  {constructor(config?: properties);
user_state: object;
content: GLib.String;
doc: XMLInDoc;
node: XMLInNode;
...
export class XMLInDoc  {constructor(config?: properties);
...
export class XMLInNS  {constructor(config?: properties);
uri: string;
ns_id: number;
}
export class XMLInNode  {constructor(config?: properties);
id: string;
ns_id: number;
name: string;
parent_id: string;
...
export class XMLOutClass  {constructor(config?: properties);
