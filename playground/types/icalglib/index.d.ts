 ...
 */
export function memory_free_ring(): void;
/**
 ...
 */
export function request_status_from_num(major: unknown, minor: unknown): RequestStatus;
/**
 * Return the major number for a request status
 */
export function request_status_major(stat: RequestStatus): unknown;
/**
 * Return the minor number for a request status
 */
export function request_status_minor(stat: RequestStatus): unknown;
/**
...
export class Array extends Object {constructor(config?: properties);
...
size(): number;
sort(compare: object | null): void;
}
export class Attach extends Object {constructor(config?: properties);
...
export class CompIter extends Object {constructor(config?: properties);
static new_full(_native: object | null): CompIter;
deref(): Component;
next(): Component;
prior(): Component;
static new_default(): object | null;
}
export class Component extends Object {constructor(config?: properties);
...
export class Datetimeperiod extends Object {constructor(config?: properties);
...
export class Duration extends Object {constructor(config?: properties);
...
export class Geo extends Object {constructor(config?: properties);
...
static construct(object_type: unknown, _native: object | null, native_destroy_func: GLib.DestroyNotify, is_global_memory: boolean, owner: GObject.Object | null): object | null;
static free_global_objects(): void;
}
export class Parameter extends Object {constructor(config?: properties);
...
export class Parser extends Object {constructor(config?: properties);
...
export class Period extends Object {constructor(config?: properties);
...
export class Property extends Object {constructor(config?: properties);
...
export class RecurIterator extends Object {constructor(config?: properties);
static new_full(_native: unknown, owner: GObject.Object): RecurIterator;
free(): void;
next(): Time;
set_start(start: Time): number;
}
export class Recurrence extends Object {constructor(config?: properties);
static new_from_string(str: string): Recurrence;
static new_full(_native: object | null): Recurrence;
clear(): void;
get_by_day(index: number): unknown;
get_by_day_array(): unknown[];
get_by_hour(index: number): unknown;
get_by_hour_array(): unknown[];
get_by_minute(index: number): unknown;
get_by_minute_array(): unknown[];
get_by_month(index: number): unknown;
get_by_month_array(): unknown[];
get_by_month_day(index: number): unknown;
get_by_month_day_array(): unknown[];
get_by_second(index: number): unknown;
get_by_second_array(): unknown[];
get_by_set_pos(index: number): unknown;
get_by_set_pos_array(): unknown[];
get_by_week_no(index: number): unknown;
get_by_week_no_array(): unknown[];
get_by_year_day(index: number): unknown;
get_by_year_day_array(): unknown[];
get_count(): number;
get_freq(): RecurrenceFrequency;
get_interval(): unknown;
get_until(): Time;
get_week_start(): RecurrenceWeekday;
set_by_day(index: number, value: unknown): void;
set_by_day_array(values: unknown[]): void;
set_by_hour(index: number, value: unknown): void;
set_by_hour_array(values: unknown[]): void;
set_by_minute(index: number, value: unknown): void;
set_by_minute_array(values: unknown[]): void;
set_by_month(index: number, value: unknown): void;
set_by_month_array(values: unknown[]): void;
set_by_month_day(index: number, value: unknown): void;
set_by_month_day_array(values: unknown[]): void;
set_by_second(index: number, value: unknown): void;
set_by_second_array(values: unknown[]): void;
set_by_set_pos(index: number, value: unknown): void;
set_by_set_pos_array(values: unknown[]): void;
set_by_week_no(index: number, value: unknown): void;
set_by_week_no_array(values: unknown[]): void;
set_by_year_day(index: number, value: unknown): void;
set_by_year_day_array(values: unknown[]): void;
set_count(count: number): void;
set_freq(freq: RecurrenceFrequency): void;
set_interval(interval: unknown): void;
set_until(until: Time): void;
set_week_start(week_start: RecurrenceWeekday): void;
to_string(): string;
static day_day_of_week(day: unknown): RecurrenceWeekday;
static day_position(day: unknown): number;
static frequency_from_string(str: string): RecurrenceFrequency;
static frequency_to_string(kind: RecurrenceFrequency): string;
static month_is_leap(month: unknown): boolean;
static month_month(month: unknown): number;
static new_default(): object | null;
...
export class Reqstat extends Object {constructor(config?: properties);
...
export class Time extends Object {constructor(config?: properties);
...
export class TimeSpan extends Object {constructor(config?: properties);
...
export class Timezone extends Object {constructor(config?: properties);
...
static array_destroy(zones_array: unknown | null): void;
static array_element_at(timezones: Array, index: number): Timezone;
static array_free(timezones: Array): void;
static destroy(zone: unknown): void;
...
export class Trigger extends Object {constructor(config?: properties);
...
export class Value extends Object {constructor(config?: properties);
...
export class ArrayClass  {constructor(config?: properties);
}
export class AttachClass  {constructor(config?: properties);
}
export class CompIterClass  {constructor(config?: properties);
}
export class ComponentClass  {constructor(config?: properties);
}
export class DatetimeperiodClass  {constructor(config?: properties);
}
export class DurationClass  {constructor(config?: properties);
}
export class GeoClass  {constructor(config?: properties);
}
...
export class ParameterClass  {constructor(config?: properties);
}
export class ParserClass  {constructor(config?: properties);
}
export class PeriodClass  {constructor(config?: properties);
}
export class PropertyClass  {constructor(config?: properties);
}
export class RecurIteratorClass  {constructor(config?: properties);
}
export class RecurrenceClass  {constructor(config?: properties);
}
export class ReqstatClass  {constructor(config?: properties);
}
export class TimeClass  {constructor(config?: properties);
}
export class TimeSpanClass  {constructor(config?: properties);
}
export class TimezoneClass  {constructor(config?: properties);
}
export class TriggerClass  {constructor(config?: properties);
}
export class ValueClass  {constructor(config?: properties);
}
export class _Array  {constructor(config?: properties);
}
export class _Attach  {constructor(config?: properties);
}
export class _CompIter  {constructor(config?: properties);
}
export class _Component  {constructor(config?: properties);
}
export class _Datetimeperiod  {constructor(config?: properties);
}
export class _Duration  {constructor(config?: properties);
}
export class _Geo  {constructor(config?: properties);
}
export class _Parameter  {constructor(config?: properties);
}
export class _Parser  {constructor(config?: properties);
}
export class _Period  {constructor(config?: properties);
}
export class _Property  {constructor(config?: properties);
}
export class _RecurIterator  {constructor(config?: properties);
}
export class _Recurrence  {constructor(config?: properties);
}
export class _Reqstat  {constructor(config?: properties);
}
export class _Time  {constructor(config?: properties);
}
export class _TimeSpan  {constructor(config?: properties);
}
export class _Timezone  {constructor(config?: properties);
}
export class _Trigger  {constructor(config?: properties);
}
export class _Value  {constructor(config?: properties);
}