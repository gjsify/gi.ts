...
export class Pixbuf extends GObject.Object {constructor(config?: properties);
...
static new_from_file(filename: unknown): Pixbuf;
static new_from_file_at_scale(filename: unknown, width: number, height: number, preserve_aspect_ratio: boolean): Pixbuf;
static new_from_file_at_size(filename: unknown, width: number, height: number): Pixbuf;
...
save(filename: unknown, type: string, error: GLib.Error | null, ___: unknown[]): boolean;
save_to_buffer(type: string, error: GLib.Error | null, ___: unknown[]): [boolean, number[],number];
save_to_bufferv(type: string, option_keys: string[], option_values: string[]): [boolean, number[],number];
save_to_callback(save_func: PixbufSaveFunc, user_data: object | null, type: string, error: GLib.Error | null, ___: unknown[]): boolean;
...
save_to_stream(stream: Gio.OutputStream, type: string, cancellable: Gio.Cancellable | null, error: GLib.Error | null, ___: unknown[]): boolean;
save_to_stream_async(stream: Gio.OutputStream, type: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null, user_data: object | null, ___: unknown[]): void;
...
savev(filename: unknown, type: string, option_keys: string[], option_values: string[]): boolean;
...
static get_file_info(filename: unknown): [PixbufFormat | null, number | null,number | null];
static get_file_info_async(filename: unknown, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null, user_data: object | null): void;
...
export class PixbufAnimation extends GObject.Object {constructor(config?: properties);
static new_from_file(filename: unknown): PixbufAnimation;
...
export class PixbufAnimationIter  {constructor(config?: properties);
advance(current_time: GLib.TimeVal | null): boolean;
get_delay_time(): number;
get_pixbuf(): Pixbuf;
on_currently_loading_frame(): boolean;
}
export class PixbufLoader extends GObject.Object {constructor(config?: properties);
...
export class PixbufSimpleAnim extends PixbufAnimation {constructor(config?: properties);
loop: boolean;
add_frame(pixbuf: Pixbuf): void;
get_loop(): boolean;
set_loop(loop: boolean): void;
}
export class PixbufSimpleAnimIter  {constructor(config?: properties);
}
export class PixbufFormat  {constructor(config?: properties);
copy(): PixbufFormat;
free(): void;
...
export class PixbufLoaderClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly size_prepared: unknown;
readonly area_prepared: unknown;
readonly area_updated: unknown;
readonly closed: unknown;
}
export class PixbufSimpleAnimClass  {constructor(config?: properties);
}