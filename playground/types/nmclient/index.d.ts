...
export class AccessPoint extends Object {constructor(config?: properties);
...
export class ActiveConnection extends Object {constructor(config?: properties);
...
export class Client extends Object {constructor(config?: properties);
...
export class DHCP4Config extends Object {constructor(config?: properties);
readonly options: GLib.HashTable;
get_one_option(option: string): string;
get_options(): GLib.HashTable;
}
export class DHCP6Config extends Object {constructor(config?: properties);
readonly options: GLib.HashTable;
get_one_option(option: string): string;
get_options(): GLib.HashTable;
}
export class Device extends Object {constructor(config?: properties);
...
vfunc_get_setting_type(): unknown;
...
export class DeviceAdsl extends Device {constructor(config?: properties);
readonly carrier: boolean;
get_carrier(): boolean;
}
export class DeviceBond extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceBridge extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
readonly slaves: unknown;
get_carrier(): boolean;
...
export class DeviceBt extends Device {constructor(config?: properties);
...
export class DeviceEthernet extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceGeneric extends Device {constructor(config?: properties);
readonly hw_address: string;
readonly type_description: string;
get_hw_address(): string;
}
export class DeviceInfiniband extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
get_carrier(): boolean;
get_hw_address(): string;
...
export class DeviceOlpcMesh extends Device {constructor(config?: properties);
...
export class DeviceTeam extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
readonly slaves: unknown;
get_carrier(): boolean;
...
export class DeviceVlan extends Device {constructor(config?: properties);
readonly carrier: boolean;
readonly hw_address: string;
...
export class DeviceWifi extends Device {constructor(config?: properties);
...
export class DeviceWimax extends Device {constructor(config?: properties);
...
export class IP4Config extends Object {constructor(config?: properties);
...
export class IP6Config extends Object {constructor(config?: properties);
...
export class RemoteConnection extends NetworkManager.Connection {constructor(config?: properties);
bus: unknown;
dbus_connection: unknown;
dbus_path: string;
...
export class RemoteSettings extends GObject.Object {constructor(config?: properties);
bus: unknown;
...
export class SecretAgent  {constructor(config?: properties);
...
export class VPNConnection extends ActiveConnection {constructor(config?: properties);
...
export class WimaxNsp extends Object {constructor(config?: properties);
readonly name: string;
...
readonly _reserved5: unknown;
readonly _reserved6: unknown;
}
...
export class DHCP4ConfigClass  {constructor(config?: properties);
readonly _reserved1: unknown;
readonly _reserved2: unknown;
readonly _reserved3: unknown;
readonly _reserved4: unknown;
...
export class DHCP6ConfigClass  {constructor(config?: properties);
readonly _reserved1: unknown;
readonly _reserved2: unknown;
readonly _reserved3: unknown;
readonly _reserved4: unknown;
...
export class IP4ConfigClass  {constructor(config?: properties);
readonly _reserved1: unknown;
readonly _reserved2: unknown;
readonly _reserved3: unknown;
readonly _reserved4: unknown;
...
export class IP6ConfigClass  {constructor(config?: properties);
readonly _reserved1: unknown;
readonly _reserved2: unknown;
readonly _reserved3: unknown;
readonly _reserved4: unknown;
...
export class RemoteSettingsClass  {constructor(config?: properties);
readonly new_connection: unknown;
readonly connections_read: unknown;
readonly _reserved1: unknown;
readonly _reserved2: unknown;
readonly _reserved3: unknown;
readonly _reserved4: unknown;
...
export class SecretAgentClass  {constructor(config?: properties);
