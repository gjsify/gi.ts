...
vfunc_stream_new(handle: object | null): Stream;
}
export class Domain  {constructor(config?: properties);
handle: unknown;
...
export class DomainDisk  {constructor(config?: properties);
...
export class DomainSnapshot  {constructor(config?: properties);
handle: unknown;
...
export class Network  {constructor(config?: properties);
handle: unknown;
...
export class NetworkDHCPLease  {constructor(config?: properties);
handle: object;
...
export class NetworkFilter  {constructor(config?: properties);
handle: unknown;
...
export class NodeDevice  {constructor(config?: properties);
handle: unknown;
readonly priv: NodeDevicePrivate;
get_config(flags: number): LibvirtGConfig.NodeDevice;
get_name(): string;
}
export class Secret  {constructor(config?: properties);
handle: unknown;
...
export class StoragePool  {constructor(config?: properties);
handle: unknown;
...
export class StorageVol  {constructor(config?: properties);
handle: unknown;
pool: StoragePool;
...
add_watch(cond: StreamIOCondition, func: StreamIOFunc, opaque: object | null): number;
...
readonly connection_opened: unknown;
readonly connection_closed: unknown;
readonly domain_added: unknown;
readonly domain_removed: unknown;
readonly stream_new: unknown;
...
export class DomainDiskStats  {constructor(config?: properties);
rd_req: number;
rd_bytes: number;
wr_req: number;
wr_bytes: number;
...
export class DomainInfo  {constructor(config?: properties);
state: DomainState;
maxMem: number;
memory: number;
nrVirtCpu: number;
...
export class DomainInterfaceStats  {constructor(config?: properties);
rx_bytes: number;
rx_packets: number;
rx_errs: number;
rx_drop: number;
...
export class NetworkDHCPLeaseClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly padding: object[];
}
export class NetworkDHCPLeasePrivate  {constructor(config?: properties);
}
...
export class NodeInfo  {constructor(config?: properties);
model: number[];
memory: number;
cpus: number;
mhz: number;
...
export class StoragePoolInfo  {constructor(config?: properties);
...
export class StorageVolInfo  {constructor(config?: properties);
type: StorageVolType;
capacity: number;
allocation: number;
}
