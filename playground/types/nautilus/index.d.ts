 ...
 */
export function module_list_types(): [unknown[],number];
/**
...
export class Column extends GObject.Object {constructor(config?: properties);
attribute: string;
...
export class Menu extends GObject.Object {constructor(config?: properties);
...
export class PropertyPage extends GObject.Object {constructor(config?: properties);
label: Gtk.Widget;
name: string;
page: Gtk.Widget;
}
...
export class ColumnProviderInterface  {constructor(config?: properties);
g_iface: GObject.TypeInterface;
readonly get_columns: unknown;
}
export class File  {constructor(config?: properties);
}
export class FileInfoInterface  {constructor(config?: properties);
readonly g_iface: GObject.TypeInterface;
readonly is_gone: unknown;
readonly get_name: unknown;
readonly get_uri: unknown;
readonly get_parent_uri: unknown;
readonly get_uri_scheme: unknown;
readonly get_mime_type: unknown;
readonly is_mime_type: unknown;
readonly is_directory: unknown;
readonly add_emblem: unknown;
readonly get_string_attribute: unknown;
readonly add_string_attribute: unknown;
readonly invalidate_extension_info: unknown;
readonly get_activation_uri: unknown;
readonly get_file_type: unknown;
readonly get_location: unknown;
readonly get_parent_location: unknown;
readonly get_parent_info: unknown;
readonly get_mount: unknown;
readonly can_write: unknown;
}
export class InfoProviderInterface  {constructor(config?: properties);
g_iface: GObject.TypeInterface;
readonly update_file_info: unknown;
readonly cancel_update: unknown;
}
export class LocationWidgetProviderInterface  {constructor(config?: properties);
g_iface: GObject.TypeInterface;
...
export class MenuProviderInterface  {constructor(config?: properties);
g_iface: GObject.TypeInterface;
readonly get_file_items: unknown;
readonly get_background_items: unknown;
}
export class OperationHandle  {constructor(config?: properties);
}
export class PropertyPageClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class PropertyPageProviderInterface  {constructor(config?: properties);
g_iface: GObject.TypeInterface;
readonly get_pages: unknown;
}
