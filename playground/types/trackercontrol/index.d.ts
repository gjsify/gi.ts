...
export class MinerManager extends GObject.Object {constructor(config?: properties);
auto_start: boolean;
...
export class MinerManagerClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly miner_progress: unknown;
readonly miner_paused: unknown;
readonly miner_resumed: unknown;
readonly miner_activated: unknown;
readonly miner_deactivated: unknown;
}