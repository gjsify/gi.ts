...
export class FlickrProxy extends Rest.Proxy {constructor(config?: properties);
api_key: string;
...
export class FlickrProxyCall  {constructor(config?: properties);
upload: boolean;
}
export class LastfmProxy extends Rest.Proxy {constructor(config?: properties);
api_key: string;
secret: string;
...
export class LastfmProxyCall  {constructor(config?: properties);
}
export class YoutubeProxy extends Rest.Proxy {constructor(config?: properties);
...
export class FlickrProxyCallClass  {constructor(config?: properties);
readonly parent_class: Rest.ProxyCallClass;
readonly _padding_dummy: object[];
}
export class FlickrProxyClass  {constructor(config?: properties);
readonly parent_class: Rest.ProxyClass;
readonly _padding_dummy: object[];
}
export class FlickrProxyPrivate  {constructor(config?: properties);
}
export class LastfmProxyCallClass  {constructor(config?: properties);
readonly parent_class: Rest.ProxyCallClass;
readonly _padding_dummy: object[];
}
export class LastfmProxyClass  {constructor(config?: properties);
readonly parent_class: Rest.ProxyClass;
readonly _padding_dummy: object[];
}
export class LastfmProxyPrivate  {constructor(config?: properties);
}
export class YoutubeProxyClass  {constructor(config?: properties);
readonly parent_class: Rest.ProxyClass;
readonly _padding_dummy: object[];
}
export class YoutubeProxyPrivate  {constructor(config?: properties);
}