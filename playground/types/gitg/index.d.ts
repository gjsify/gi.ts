 ...
 * 
 */
export function commit_model_columns_type(): GType;
/**
 * 
 */
...
export class Repository extends Ggit.Repository {
    ...
    lookup(t_type: GType, t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify, id: Ggit.OId): object | null;
...
export class Sidebar extends Gtk.TreeView {
    ...
    get_selected_item(t_type: GType, t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify): object | null;
    get_selected_items(t_type: GType, t_dup_func: GObject.BoxedCopyFunc, t_destroy_func: GLib.DestroyNotify): [object[], number];
