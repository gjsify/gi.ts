...
export class OAuth2Proxy extends Proxy {constructor(config?: properties);
access_token: string;
...
export class OAuth2ProxyCall  {constructor(config?: properties);
}
export class OAuthProxy extends Proxy {constructor(config?: properties);
consumer_key: string;
...
export class OAuthProxyCall  {constructor(config?: properties);
parse_token_reponse(): void;
parse_token_response(): void;
}
export class Proxy extends GObject.Object {constructor(config?: properties);
...
bind(___: unknown[]): boolean;
bind_valist(params: any): boolean;
get_user_agent(): string;
new_call(): ProxyCall;
set_user_agent(user_agent: string): void;
simple_run(payload: string, len: number, error: GLib.Error, ___: unknown[]): boolean;
simple_run_valist(payload: string, len: number, error: GLib.Error, params: any): boolean;
vfunc_authenticate(auth: ProxyAuth, retrying: boolean): boolean;
vfunc_bind_valist(params: any): boolean;
vfunc_new_call(): ProxyCall;
vfunc_simple_run_valist(payload: string, len: number, error: GLib.Error, params: any): boolean;
}
export class ProxyAuth  {constructor(config?: properties);
readonly priv: ProxyAuthPrivate;
cancel(): void;
pause(): void;
unpause(): void;
}
export class ProxyCall  {constructor(config?: properties);
proxy: Proxy;
readonly priv: ProxyCallPrivate;
add_header(header: string, value: string): void;
add_headers(___: unknown[]): void;
add_headers_from_valist(headers: any): void;
add_param(name: string, value: string): void;
add_param_full(param: Param): void;
add_params(___: unknown[]): void;
add_params_from_valist(params: any): void;
async(callback: ProxyCallAsyncCallback, weak_object: GObject.Object, userdata: object | null): boolean;
cancel(): boolean;
continuous(callback: ProxyCallContinuousCallback, weak_object: GObject.Object, userdata: object | null): boolean;
get_function(): string;
get_method(): string;
get_params(): Params;
get_payload(): string;
...
export class XmlParser extends GObject.Object {constructor(config?: properties);
parse_from_data(data: string, len: number): XmlNode;
}
export class OAuth2ProxyCallClass  {constructor(config?: properties);
readonly parent_class: ProxyCallClass;
readonly _padding_dummy: object[];
}
export class OAuth2ProxyClass  {constructor(config?: properties);
readonly parent_class: ProxyClass;
readonly _padding_dummy: object[];
}
export class OAuth2ProxyPrivate  {constructor(config?: properties);
}
export class OAuthProxyCallClass  {constructor(config?: properties);
readonly parent_class: ProxyCallClass;
readonly _padding_dummy: object[];
}
export class OAuthProxyClass  {constructor(config?: properties);
readonly parent_class: ProxyClass;
readonly _padding_dummy: object[];
}
...
export class Params  {constructor(config?: properties);
...
export class ParamsIter  {constructor(config?: properties);
init(params: Params): void;
next(name: string, param: Param): boolean;
}
export class ProxyAuthClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _padding_dummy: object[];
}
export class ProxyAuthPrivate  {constructor(config?: properties);
}
export class ProxyCallClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly prepare: unknown;
readonly serialize_params: unknown;
readonly _padding_dummy: object[];
}
export class ProxyCallPrivate  {constructor(config?: properties);
}
export class ProxyClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly bind_valist: unknown;
readonly new_call: unknown;
readonly simple_run_valist: unknown;
...
export class XmlParserClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}