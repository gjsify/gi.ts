...
export class Checker extends GObject.Object {constructor(config?: properties);
language: Language;
...
export class CheckerDialog extends Gtk.Dialog {constructor(config?: properties);
...
export class EntryBuffer  {constructor(config?: properties);
...
export class LanguageChooserButton extends Gtk.Button {constructor(config?: properties);
}
export class LanguageChooserDialog extends Gtk.Dialog {constructor(config?: properties);
}
export class NavigatorTextView  {constructor(config?: properties);
view: Gtk.TextView;
get_view(): Gtk.TextView;
static _new(view: Gtk.TextView): Navigator;
}
export class TextBuffer  {constructor(config?: properties);
...
export class TextView  {constructor(config?: properties);
...
readonly word_added_to_personal: unknown;
readonly word_added_to_session: unknown;
readonly session_cleared: unknown;
readonly padding: object[];
}
export class CheckerDialogClass  {constructor(config?: properties);
...
export class LanguageChooserButtonClass  {constructor(config?: properties);
readonly parent_class: Gtk.ButtonClass;
readonly padding: object[];
}
export class LanguageChooserDialogClass  {constructor(config?: properties);
readonly parent_class: Gtk.DialogClass;
readonly padding: object[];
}
export class LanguageChooserInterface  {constructor(config?: properties);
readonly parent_interface: GObject.TypeInterface;
readonly get_language_full: unknown;
readonly set_language: unknown;
}
export class NavigatorInterface  {constructor(config?: properties);
readonly parent_interface: GObject.TypeInterface;
readonly goto_next: unknown;
readonly change: unknown;
readonly change_all: unknown;
}
export class NavigatorTextViewClass  {constructor(config?: properties);
