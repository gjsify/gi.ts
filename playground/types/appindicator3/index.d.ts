...
export class Indicator extends GObject.Object {constructor(config?: properties);
attention_icon_desc: string;
attention_icon_name: string;
category: string;
readonly connected: boolean;
dbus_menu_server: unknown;
icon_desc: string;
icon_name: string;
...
readonly new_icon: unknown;
readonly new_attention_icon: unknown;
readonly new_status: unknown;
readonly new_icon_theme_path: unknown;
readonly new_label: unknown;
readonly connection_changed: unknown;
readonly scroll_event: unknown;
readonly app_indicator_reserved_ats: unknown;
readonly fallback: unknown;
readonly unfallback: unknown;
readonly app_indicator_reserved_1: unknown;
readonly app_indicator_reserved_2: unknown;
readonly app_indicator_reserved_3: unknown;
readonly app_indicator_reserved_4: unknown;
readonly app_indicator_reserved_5: unknown;
readonly app_indicator_reserved_6: unknown;
}
