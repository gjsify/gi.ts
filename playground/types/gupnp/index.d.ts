...
export class Context extends GSSDP.Client {constructor(config?: properties);
acl: Acl;
...
export class ContextManager  {constructor(config?: properties);
...
export class ControlPoint extends GSSDP.ResourceBrowser {constructor(config?: properties);
...
export class DeviceInfo  {constructor(config?: properties);
context: Context;
device_type: string;
document: XMLDoc;
element: object;
...
export class DeviceProxy  {constructor(config?: properties);
}
export class ResourceFactory extends GObject.Object {constructor(config?: properties);
register_resource_proxy_type(upnp_type: string, type: unknown): void;
register_resource_type(upnp_type: string, type: unknown): void;
...
export class RootDevice extends Device {constructor(config?: properties);
available: boolean;
...
root_device: RootDevice;
freeze_notify(): void;
notify(___: unknown[]): void;
notify_valist(var_args: any): void;
notify_value(variable: string, value: GObject.Value): void;
signals_autoconnect(user_data: object | null): void;
thaw_notify(): void;
}
export class ServiceInfo  {constructor(config?: properties);
context: Context;
document: XMLDoc;
element: object;
location: string;
...
export class ServiceIntrospection  {constructor(config?: properties);
scpd: object;
...
export class ServiceProxy  {constructor(config?: properties);
subscribed: boolean;
add_notify(variable: string, type: unknown, callback: ServiceProxyNotifyCallback, user_data: object | null): boolean;
add_notify_full(variable: string, type: unknown, callback: ServiceProxyNotifyCallback, user_data: object | null, notify: GLib.DestroyNotify | null): boolean;
add_raw_notify(callback: ServiceProxyNotifyCallback, user_data: object | null, notify: GLib.DestroyNotify | null): boolean;
begin_action(action: string, callback: ServiceProxyActionCallback, user_data: object | null, ___: unknown[]): ServiceProxyAction;
...
begin_action_valist(action: string, callback: ServiceProxyActionCallback, user_data: object | null, var_args: any): ServiceProxyAction;
...
end_action(action: ServiceProxyAction, error: GLib.Error | null, ___: unknown[]): boolean;
...
end_action_valist(action: ServiceProxyAction, error: GLib.Error | null, var_args: any): boolean;
...
send_action(action: string, error: GLib.Error | null, ___: unknown[]): boolean;
...
send_action_valist(action: string, error: GLib.Error | null, var_args: any): boolean;
set_subscribed(subscribed: boolean): void;
}
export class WhiteList extends GObject.Object {constructor(config?: properties);
enabled: boolean;
entries: GLib.List;
...
export class XMLDoc extends GObject.Object {constructor(config?: properties);
static new_from_path(path: string): XMLDoc;
get_doc(): libxml2.Doc;
}
export class AclInterface  {constructor(config?: properties);
readonly is_allowed: unknown;
readonly is_allowed_async: unknown;
readonly is_allowed_finish: unknown;
readonly can_sync: unknown;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
readonly _gupnp_reserved4: unknown;
}
...
export class ContextManagerClass  {constructor(config?: properties);
...
export class ControlPointClass  {constructor(config?: properties);
readonly parent_class: GSSDP.ResourceBrowserClass;
readonly device_proxy_available: unknown;
readonly device_proxy_unavailable: unknown;
readonly service_proxy_available: unknown;
readonly service_proxy_unavailable: unknown;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
}
...
export class DeviceInfoClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly get_element: unknown;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
readonly _gupnp_reserved4: unknown;
}
export class DeviceProxyClass  {constructor(config?: properties);
readonly parent_class: DeviceInfoClass;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
...
export class ResourceFactoryClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
...
export class RootDeviceClass  {constructor(config?: properties);
...
export class ServiceAction  {constructor(config?: properties);
get(___: unknown[]): void;
get_argument_count(): number;
get_gvalue(argument: string, type: unknown): GObject.Value;
get_locales(): GLib.List;
get_message(): Soup.Message;
get_name(): string;
get_valist(var_args: any): void;
get_value(argument: string, value: GObject.Value): [GObject.Value];
...
set_valist(var_args: any): void;
set_value(argument: string, value: GObject.Value): void;
set_values(arg_names: GLib.List, arg_values: GLib.List): void;
}
export class ServiceActionArgInfo  {constructor(config?: properties);
name: string;
direction: ServiceActionArgDirection;
related_state_variable: string;
retval: boolean;
}
export class ServiceActionInfo  {constructor(config?: properties);
name: string;
_arguments: GLib.List;
}
export class ServiceClass  {constructor(config?: properties);
readonly parent_class: ServiceInfoClass;
readonly action_invoked: unknown;
readonly query_variable: unknown;
readonly notify_failed: unknown;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
readonly _gupnp_reserved4: unknown;
}
export class ServiceInfoClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
...
export class ServiceIntrospectionClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ServiceProxyAction  {constructor(config?: properties);
static new_from_list(action: string, in_names: GLib.List, in_values: GLib.List): ServiceProxyAction;
get_result(error: GLib.Error | null, ___: unknown[]): boolean;
...
export class ServiceProxyClass  {constructor(config?: properties);
readonly parent_class: ServiceInfoClass;
readonly subscription_lost: unknown;
readonly _gupnp_reserved1: unknown;
readonly _gupnp_reserved2: unknown;
readonly _gupnp_reserved3: unknown;
readonly _gupnp_reserved4: unknown;
}
export class ServiceStateVariableInfo  {constructor(config?: properties);
name: string;
send_events: boolean;
is_numeric: boolean;
type: unknown;
...
export class WhiteListClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class XMLDocClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
