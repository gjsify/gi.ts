...
export class HistoryItem extends GObject.Object {constructor(config?: properties);
state: number;
time: number;
value: number;
...
export class StatsItem extends GObject.Object {constructor(config?: properties);
accuracy: number;
value: number;
get_accuracy(): number;
get_value(): number;
...
export class WakeupItem extends GObject.Object {constructor(config?: properties);
cmdline: string;
details: string;
id: number;
...
export class Wakeups extends GObject.Object {constructor(config?: properties);
...
readonly _up_client_reserved1: unknown;
readonly _up_client_reserved2: unknown;
readonly _up_client_reserved3: unknown;
readonly _up_client_reserved4: unknown;
readonly _up_client_reserved5: unknown;
readonly _up_client_reserved6: unknown;
readonly _up_client_reserved7: unknown;
readonly _up_client_reserved8: unknown;
}
export class ClientPrivate  {constructor(config?: properties);
}
export class DeviceClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _up_device_reserved1: unknown;
readonly _up_device_reserved2: unknown;
readonly _up_device_reserved3: unknown;
readonly _up_device_reserved4: unknown;
readonly _up_device_reserved5: unknown;
readonly _up_device_reserved6: unknown;
readonly _up_device_reserved7: unknown;
readonly _up_device_reserved8: unknown;
}
export class DevicePrivate  {constructor(config?: properties);
}
export class HistoryItemClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class HistoryItemPrivate  {constructor(config?: properties);
}
export class StatsItemClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class StatsItemPrivate  {constructor(config?: properties);
}
export class WakeupItemClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class WakeupItemPrivate  {constructor(config?: properties);
}
export class WakeupsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly data_changed: unknown;
readonly total_changed: unknown;
}
export class WakeupsPrivate  {constructor(config?: properties);
}