...
export class Wc extends GObject.Object {constructor(config?: properties);
cache: boolean;
cache_size: number;
loglevel: number;
throttling: number;
...
request_with_headers_async(uri: string, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null, user_data: object | null, ___: unknown[]): void;
...
export class WcClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class WcPrivate  {constructor(config?: properties);
}