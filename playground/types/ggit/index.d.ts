...
export class Blame  {constructor(config?: properties);
...
export class Blob  {constructor(config?: properties);
get_raw_content(): [number[] | null, number | null];
is_binary(): boolean;
}
export class BlobOutputStream  {constructor(config?: properties);
repository: Repository;
get_id(): OId | null;
}
export class Branch  {constructor(config?: properties);
_delete(): void;
...
export class CheckoutOptions extends GObject.Object {constructor(config?: properties);
...
export class CherryPickOptions extends GObject.Object {constructor(config?: properties);
...
export class CloneOptions extends GObject.Object {constructor(config?: properties);
...
export class Commit  {constructor(config?: properties);
...
export class CommitParents extends GObject.Object {constructor(config?: properties);
commit: Commit;
...
export class Config extends Native {constructor(config?: properties);
...
export class Cred  {constructor(config?: properties);
}
export class CredPlaintext extends Cred {constructor(config?: properties);
password: string;
username: string;
get_password(): string;
get_username(): string;
}
export class CredSshInteractive extends Cred {constructor(config?: properties);
username: string;
get_username(): string;
vfunc_prompt(prompts: CredSshInteractivePrompt[], num_prompts: number): void;
}
export class CredSshKeyFromAgent extends Cred {constructor(config?: properties);
username: string;
get_username(): string | null;
}
export class Diff extends Native {constructor(config?: properties);
...
export class DiffFindOptions extends GObject.Object {constructor(config?: properties);
...
export class DiffFormatEmailOptions extends GObject.Object {constructor(config?: properties);
author: Signature;
body: string;
...
export class DiffOptions extends GObject.Object {constructor(config?: properties);
flags: DiffOption;
...
export class Index  {constructor(config?: properties);
file: Gio.File;
...
export class Native  {constructor(config?: properties);
_native: object;
}
...
construct(parent_class: GObject.ObjectClass, basetype: unknown, n_construct_properties: number, construct_properties: GObject.ObjectConstructParam[]): GObject.Object | null;
register(basetype: unknown, subtype: unknown): void;
unregister(basetype: unknown, subtype: unknown): void;
static get_default(): ObjectFactory;
}
export class ObjectFactoryBase  {constructor(config?: properties);
}
export class ProxyOptions extends GObject.Object {constructor(config?: properties);
}
export class PushOptions extends GObject.Object {constructor(config?: properties);
...
export class Rebase  {constructor(config?: properties);
abort(): void;
...
export class Remote extends Native {constructor(config?: properties);
...
export class RemoteCallbacks  {constructor(config?: properties);
}
...
lookup(oid: OId, gtype: unknown): Object | null;
...
export class RevisionWalker extends Native {constructor(config?: properties);
repository: Repository;
...
export class Signature extends Native {constructor(config?: properties);
...
export class SubmoduleUpdateOptions extends GObject.Object {constructor(config?: properties);
checkout_options: CheckoutOptions;
...
export class Tag  {constructor(config?: properties);
get_message(): string | null;
get_name(): string | null;
get_tagger(): Signature | null;
get_target(): Object | null;
get_target_id(): OId | null;
get_target_type(): unknown;
peel(): Object | null;
}
...
export class TreeBuilder  {constructor(config?: properties);
clear(): void;
...
export class AnnotatedCommit  {constructor(config?: properties);
static new_from_ref(repository: Repository, ref: Ref): AnnotatedCommit;
get_id(): OId | null;
ref(): AnnotatedCommit | null;
unref(): void;
}
export class BlameClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class BlameHunk  {constructor(config?: properties);
...
export class BlameOptions  {constructor(config?: properties);
...
export class BlobOutputStreamClass  {constructor(config?: properties);
readonly parent_class: Gio.OutputStreamClass;
}
export class BranchClass  {constructor(config?: properties);
readonly parent_class: RefClass;
}
export class BranchEnumerator  {constructor(config?: properties);
get(): Ref | null;
...
export class CheckoutOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly notify: unknown;
readonly progress: unknown;
}
export class CherryPickOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class CloneOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly create_repository: unknown;
readonly create_remote: unknown;
}
export class CommitClass  {constructor(config?: properties);
readonly parent_class: ObjectClass;
}
export class CommitParentsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ConfigClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class ConfigEntry  {constructor(config?: properties);
...
export class CredClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class CredPlaintextClass  {constructor(config?: properties);
readonly parent_class: CredClass;
}
export class CredSshInteractiveClass  {constructor(config?: properties);
readonly parent_class: CredClass;
readonly prompt: unknown;
}
export class CredSshInteractivePrompt  {constructor(config?: properties);
...
export class CredSshKeyFromAgentClass  {constructor(config?: properties);
readonly parent_class: CredClass;
}
export class DiffBinary  {constructor(config?: properties);
get_new_file(): DiffBinaryFile | null;
get_old_file(): DiffBinaryFile | null;
ref(): DiffBinary | null;
unref(): void;
}
export class DiffBinaryFile  {constructor(config?: properties);
...
export class DiffClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class DiffDelta  {constructor(config?: properties);
get_flags(): DiffFlag;
...
export class DiffFile  {constructor(config?: properties);
get_flags(): DiffFlag;
get_mode(): number;
get_oid(): OId | null;
...
export class DiffFindOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DiffFormatEmailOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DiffHunk  {constructor(config?: properties);
get_header(): string;
...
export class DiffLine  {constructor(config?: properties);
...
export class DiffOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class DiffSimilarityMetric  {constructor(config?: properties);
copy(): DiffSimilarityMetric | null;
free(): void;
}
export class FetchOptions  {constructor(config?: properties);
...
export class IndexEntries  {constructor(config?: properties);
...
export class IndexEntriesResolveUndo  {constructor(config?: properties);
...
export class IndexEntry  {constructor(config?: properties);
get_dev(): number;
...
export class IndexEntryResolveUndo  {constructor(config?: properties);
...
export class MergeOptions  {constructor(config?: properties);
...
export class NativeClass  {constructor(config?: properties);
readonly parent_class: ObjectFactoryBaseClass;
}
export class Note  {constructor(config?: properties);
get_id(): OId | null;
get_message(): string | null;
ref(): Note | null;
unref(): void;
}
export class OId  {constructor(config?: properties);
...
export class ObjectFactoryBaseClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class ObjectFactoryClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class Patch  {constructor(config?: properties);
...
export class ProxyOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class PushOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class RebaseClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class RebaseOperation  {constructor(config?: properties);
...
export class RebaseOptions  {constructor(config?: properties);
...
export class RefSpec  {constructor(config?: properties);
...
export class Reflog  {constructor(config?: properties);
...
export class ReflogEntry  {constructor(config?: properties);
get_committer(): Signature | null;
get_message(): string | null;
get_new_id(): OId | null;
get_old_id(): OId | null;
...
export class RemoteCallbacksClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly progress: unknown;
readonly transfer_progress: unknown;
readonly update_tips: unknown;
...
export class RemoteHead  {constructor(config?: properties);
...
export class RevertOptions  {constructor(config?: properties);
copy(): RevertOptions | null;
free(): void;
}
export class RevisionWalkerClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class SignatureClass  {constructor(config?: properties);
readonly parent_class: NativeClass;
}
export class StatusOptions  {constructor(config?: properties);
copy(): StatusOptions | null;
free(): void;
}
export class Submodule  {constructor(config?: properties);
...
export class SubmoduleUpdateOptionsClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
}
export class TagClass  {constructor(config?: properties);
readonly parent_class: ObjectClass;
}
export class TransferProgress  {constructor(config?: properties);
