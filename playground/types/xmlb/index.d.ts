 ...
 */
export function string_append_union(xpath: GLib.String, fmt: string, ___: unknown[]): void;
/**
...
export class BuilderFixup extends GObject.Object {constructor(config?: properties);
get_max_depth(): number;
set_max_depth(max_depth: number): void;
}
export class BuilderNode extends GObject.Object {constructor(config?: properties);
...
insert(element: string, ___: unknown[]): BuilderNode;
insert_text(element: string, text: string | null, ___: unknown[]): void;
...
export class BuilderSource extends GObject.Object {constructor(config?: properties);
add_adapter(content_types: string, func: BuilderSourceAdapterFunc, user_data: object | null, user_data_free: GLib.DestroyNotify): void;
add_converter(content_types: string, func: BuilderSourceConverterFunc, user_data: object | null, user_data_free: GLib.DestroyNotify): void;
add_fixup(fixup: BuilderFixup): void;
...
export class BuilderSourceCtx  {constructor(config?: properties);
get_bytes(cancellable: Gio.Cancellable | null): GLib.Bytes;
get_filename(): string;
get_stream(): Gio.InputStream;
}
export class Machine extends GObject.Object {constructor(config?: properties);
...
export class Query extends GObject.Object {constructor(config?: properties);
...
export class Silo extends GObject.Object {constructor(config?: properties);
guid: string;
...
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
readonly _xb_reserved4: unknown;
readonly _xb_reserved5: unknown;
readonly _xb_reserved6: unknown;
readonly _xb_reserved7: unknown;
}
export class BuilderFixupClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class BuilderNodeClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class BuilderSourceClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class BuilderSourceCtxClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class MachineClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class NodeClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class Opcode  {constructor(config?: properties);
...
export class QueryClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class SiloClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly _xb_reserved1: unknown;
readonly _xb_reserved2: unknown;
readonly _xb_reserved3: unknown;
...
export class Stack  {constructor(config?: properties);
pop(): Opcode;
