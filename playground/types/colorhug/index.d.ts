...
export class DeviceQueue extends GObject.Object {constructor(config?: properties);
...
export class DeviceQueueClass  {constructor(config?: properties);
readonly parent_class: GObject.ObjectClass;
readonly device_failed: unknown;
readonly progress_changed: unknown;
readonly _ch_reserved1: unknown;
readonly _ch_reserved2: unknown;
readonly _ch_reserved3: unknown;
readonly _ch_reserved4: unknown;
readonly _ch_reserved5: unknown;
}
export class Sha1  {constructor(config?: properties);
bytes: number[];
to_string(): string;
